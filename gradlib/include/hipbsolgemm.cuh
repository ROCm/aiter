...
int get_algoIdx_hip_tuning_csv(const std::string filename,
                               hipblasLtHandle_t handle,
                               const bool bpreshuffle,
                               const bool use_rowwise,
...
void append_hip_tuning_csv(hipblasLtMatmulAlgo_t& algo,
                           ...
                           int32_t batch_count,
                           bool write_header_if_missing);

hipblasStatus_t hipblasLt_online_tuning(hipblasLtHandle_t handle,
                                        int m,
                                        int n,
                                        int k,
                                        ...
                                        size_t size_dB,
                                        size_t size_dC,
                                        int64_t totalRotatingSizeNeeded,
                                        hipDataType intype,
                                        hipDataType outtype,
                                        hipStream_t stream);

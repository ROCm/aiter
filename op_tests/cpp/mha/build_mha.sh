...
/opt/rocm/bin/hipcc  -I$TOP_DIR/3rdparty/composable_kernel/include \
                     ...
                     -I$SCRIPT_DIR/param_check \
                     -std=c++20 -O3 \
                     -DUSE_ROCM=1 \
                     -DCK_TILE_FMHA_FWD_SPLITKV_API=1 \
                     --offload-arch=native \
                     -L $SCRIPT_DIR -lmha_fwd \
                     $SCRIPT_DIR/benchmark_mha_fwd.cpp $SCRIPT_DIR/param_check/mha_fwd_param_v3_check.cpp -o benchmark_mha_fwd
fi
...
/opt/rocm/bin/hipcc  -I$TOP_DIR/3rdparty/composable_kernel/include \
                     ...
                     $SCRIPT_DIR/benchmark_mha_bwd.cpp $SCRIPT_DIR/param_check/mha_bwd_param_v3_check.cpp -o benchmark_mha_bwd
fi

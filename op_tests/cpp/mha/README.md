...
![non-casual-bwd-perf picture](images/casual-fwd-perf.png)
![casual-bwd-perf picture](images/non-casual-fwd-perf.png)
*Figure 1: Evaluating GQA attention forwards performance under the conditions of batch=8, q_nheads=64 and kv_nheads=8.*

![non-casual-bwd-perf picture](images/casual-bwd-perf.png)
![casual-bwd-perf picture](images/non-casual-bwd-perf.png)

...
class TestTypedCandidateStatus(unittest.TestCase):
    ...
    def test_status_extension_is_opt_in(self):
        ...
        # Callers that ask for status also receive the diagnostic slot, empty
        # on success. Callers that do not are unaffected.
    ...
    def test_failure_detail_is_bounded_and_single_line(self):
        ...
        # A traceback-sized message must not become a journal row of its own.

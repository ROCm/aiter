...
"""Correctness oracle for heterogeneous MXFP4/FP8 fused MoE.
...
def test_dsv4_bm16_dispatch():
    """Validate the tuned C32/C64 route used by heterogeneous FSE."""
    if get_gfx() != "gfx950":
        pytest.skip("BM16 production dispatch is tuned for gfx950")

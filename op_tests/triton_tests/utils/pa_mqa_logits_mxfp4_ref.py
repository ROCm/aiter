...
"""Inverse cache layout and packing for the paged MXFP4 MQA-logits tests."""

import torch

from aiter.ops.triton.attention.pa_mqa_logits_mxfp4 import K_WIDTH, SCALE_MODE_WIDE

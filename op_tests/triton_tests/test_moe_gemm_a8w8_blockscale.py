...
@pytest.mark.parametrize(
    ...
    [
        ...
        for case in [
            # 2D blockscale
            Case(16, 4096, 7168, 256, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=False),
            Case(256, 7168, 2048, 256, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=False),
            Case(1024, 4096, 7168, 256, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=False),
            Case(8192, 7168, 2048, 256, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=False),
            Case(4, 300, 300, 8, 4, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=False),
            Case(4, 256, 256, 8, 2, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=False),
            # Per-row x scale
            Case(16, 4096, 7168, 256, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=True),
            Case(256, 7168, 2048, 256, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=True),
            Case(1024, 4096, 7168, 256, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=True),
            Case(8192, 7168, 2048, 256, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=True),
            Case(4, 300, 300, 8, 4, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=True),
            Case(4, 256, 256, 8, 2, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=True),
            # Mixed quantization 2D blockscale
            Case(16, 512, 1024, 128, 4, is_x_blockscale=False, is_w_blockscale=False, per_row_x_scale=False),
            Case(256, 1024, 2048, 128, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=False),
            Case(1024, 7168, 4096, 256, 4, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=False),
            Case(2048, 4096, 7168, 256, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=False),
            Case(4, 300, 300, 8, 2, is_x_blockscale=False, is_w_blockscale=True, per_row_x_scale=False),
            Case(4, 300, 300, 8, 4, is_x_blockscale=True, is_w_blockscale=False, per_row_x_scale=False),
            # Mixed quantization 2D blockscale
            Case(16, 512, 1024, 128, 4, is_x_blockscale=False, is_w_blockscale=False, per_row_x_scale=True),
            Case(256, 1024, 2048, 128, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=True),
            Case(1024, 7168, 4096, 256, 4, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=True),
            Case(2048, 4096, 7168, 256, 8, is_x_blockscale=True, is_w_blockscale=True, per_row_x_scale=True),
            Case(4, 300, 300, 8, 2, is_x_blockscale=False, is_w_blockscale=True, per_row_x_scale=True),
            Case(4, 300, 300, 8, 4, is_x_blockscale=True, is_w_blockscale=False, per_row_x_scale=True),
        ]
    ],
)
@pytest.mark.parametrize(
...
def test_op(
    ...
    if is_x_blockscale:
        x_ref = dequant_x_blockscale(x_tri, x_scales_tri, per_row_x_scale, group_shape).to(torch.bfloat16)
    else:
        x_ref = (x_tri.float() * x_static_scale).to(torch.bfloat16)

    if is_w_blockscale:
        w_ref = dequant_w_blockscale(w_tri, w_scales_tri, group_shape).to(torch.bfloat16)
    else:

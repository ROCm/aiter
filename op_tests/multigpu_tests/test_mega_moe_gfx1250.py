...
# The MegaMoE (fused) dispatch wire. Unrelated to `transport` above, which
# belongs to the mori-v1 dispatch the base combine uses.
...
def _parse_args():
    ...
    p.add_argument(
        ...
        help="MegaMoE (--combine fused) dispatch wire: bf16 sends activations and "

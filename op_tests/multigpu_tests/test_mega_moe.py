...
unchanged in separate ``get_gfx()`` branches below. Only the matching branch is
imported and executed on a given machine.
"""
...
# Keep both original runners byte-for-byte apart from indentation and the
# nested future import removed above.
# fmt: off
if _GFX == "gfx950":
    # SPDX-License-Identifier: MIT
    # Copyright (C) 2024-2026, Advanced Micro Devices, Inc. All rights reserved.
    ...
    print(f"Skipping Mega MoE test: requires gfx950 or gfx1250, got {_GFX}")
# fmt: on

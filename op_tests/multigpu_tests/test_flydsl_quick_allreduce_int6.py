...
# Gate vs HIP INT6 (~29.5 sim / ~30.4 GPU). Floor slightly under sim for noise.
SQNR_MIN_DB = 28.0
# Dropped/stale 32 KiB tile is ~0 dB; INT6 codec tiles stay well above this.
TILE_SQNR_MIN_DB = 20.0
# Calibrated to HIP CodecQ6 vs fp32 all-reduce, not bit identity.
CLOSE_RTOL = 5e-2
CLOSE_ATOL = 5e-2
CLOSE_ERR_RATIO = 0.35
SUPER_TILE = 8
TP = WORLD

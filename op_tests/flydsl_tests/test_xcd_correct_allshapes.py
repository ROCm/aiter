"""Correctness: jagged_dense_bmm_xcd vs torch eager across all 4 headline shapes,
each over a small C grid. cos > 0.999 required. Mi small (512) for speed, plus a
real-Mi=7680 spot-check at the best-guess C per shape."""
import torch
import importlib

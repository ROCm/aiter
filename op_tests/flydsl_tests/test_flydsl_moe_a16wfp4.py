...
``fused_moe`` dispatch (``aiter/ops/flydsl/moe_2stage_a16w4_dispatch.py``), in the
SiTUv2 / SEPARATED bf16-activation x mxfp4-weight configuration, against a bf16
SiTUv2 torch reference with a strict cos/logits_diff gate.

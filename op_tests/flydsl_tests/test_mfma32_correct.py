"""Correctness: jagged_dense_bmm_mfma32 (16x16x32 bf16 atom) vs torch eager
across all 4 headline shapes, each over a small C grid. cos > 0.999 required.
Mi small (512) for speed, plus a real-Mi=7680 spot-check at C=120 per shape."""
import torch
import importlib
import flydsl.compiler as flyc

m = importlib.import_module("aiter.ops.flydsl.kernels.jagged_dense_bmm_mfma32")

...
# args: <B> <D> <Kout> <Mi>   (uniform Mi; persist_dev kernel, kernel-only timing)
...
# Pre-build CUM on-device once (kernel-only timing: CUM build excluded). Still no
# host sync even when built here.

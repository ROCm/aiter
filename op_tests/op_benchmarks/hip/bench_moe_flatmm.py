...
def main():
    ...
    print(
        ...
        f"num_warmup={args.num_warmup}, cases={len(selected)}"
    )
    print(
        "block_m | stage1(M,N,K) | stage1_us | stage1_tflops | "
    ...
    for idx, case in selected:
        ...
        row = {
            ...
            "stage1_us": round(stage1_us, 3),
            "stage1_tflops": round(stage1_tflops, 3),
            "stage2_m": case.stage2_m,
            "stage2_n": case.stage2_n,
            "stage2_k": case.stage2_k,
            "stage2_us": round(stage2_us, 3),
            "stage2_tflops": round(stage2_tflops, 3),

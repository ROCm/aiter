...
def build_inputs(
    batch, next_n, heads, head_dim, kv_len, block_size, q_dtype, var_ratio, seed
):
    ...
    block_tables = torch.zeros(
        (batch, max_block_len), device="cuda", dtype=torch.int32
    )
...
def main():
    ...
    print(
        ...
        f"split_kv={args.split_kv or 'auto'} variant={args.variant or 'paged_w4'} "
    ...
    if args.time:
        ...
        print(
            ...
            f"{kv_bytes / us / 1e3:.1f} GB/s (KV read)"
        )

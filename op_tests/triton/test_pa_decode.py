...
'''
@pytest.mark.parametrize("B", [1, 4, 32, 57, 64])
@pytest.mark.parametrize("H_Q, H_KV", [(1,1), (4,4), (16, 16), (2,1), (48,8)])
@pytest.mark.parametrize("D", [1, 8, 16, 64, 128])
@pytest.mark.parametrize("KV_BLK_SZ", [1, 4, 16, 128, 512])
@pytest.mark.parametrize("SEQ_LEN", [1, 4, 5, 32, 57, 64, 512, 8192, 10000])
@pytest.mark.parametrize("NUM_BLK", [4, 8, 32, 100, 1000])
'''
#@pytest.mark.parametrize("B", [1])
@pytest.mark.parametrize("B", [1, 4, 16, 65])
@pytest.mark.parametrize("H_Q, H_KV", [(1,1), (16, 16), (2,1), (24,4)])
@pytest.mark.parametrize("D", [1, 64, 128])
@pytest.mark.parametrize("KV_BLK_SZ", [1, 16, 512])
@pytest.mark.parametrize("SEQ_LEN", [1, 5, 32, 57, 512, 10000])
@pytest.mark.parametrize("NUM_BLK", [4])
# q_dtype, kv_dtype, compute_type, output_type
# INT8xINT8 -> BF16-> BF16
# FP8xFP8 -> BF16-> FP8
# BF16xINT8 -> BF16-> BF16

...
def main():
    ...
    def call():
        return _maybe_grouped_gfx1250_a8w4_moe(
            inp["hidden_states"], inp["w1"], inp["w2"],
            inp["topk_weight"], inp["topk_ids"],
            E=args.E, model_dim=args.model_dim, inter_dim=args.inter_dim,
            dtype=dtype, activation=ActivationType.Silu,
            quant_type=QuantType.per_1x32, q_dtype_a=q_dtype_a,
            q_dtype_w=dtypes.fp4x2, isG1U1=True, doweight_stage1=False,
            w1_scale=inp["w1_scale"], w2_scale=inp["w2_scale"], expert_mask=None,
            hidden_pad=0, intermediate_pad=0, bias1=None, bias2=None,

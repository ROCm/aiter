...
def test_fmoe(
    ...
    if quantAlgoId == 0:
        ...
        if use_smooth and (
            ...
            ref2_f16 = ref2.to(torch.float16)
            checkAllclose(ref2_f16, out_b2, atol=100, msg=msg)
        ...
        print("ref2.dtype:", ref2.dtype)
        ref2_f16 = ref2.to(torch.float16)
        checkAllclose(ref2_f16, out_b, rtol=0.01, atol=100, msg=msg)

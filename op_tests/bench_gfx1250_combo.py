...
def main():
    ...
    # flydsl moe axes
    p.add_argument(
        "--moe-format", nargs="*", default=["a8w4"],
        choices=["a4w4", "a8w4"], help="MoE data formats (default: a8w4)",
    )
    p.add_argument("--moe-experts", type=int, default=96)
    p.add_argument("--moe-tokens", type=int, nargs="*", default=[64, 256, 512, 1024])
    p.add_argument("--moe-topk", type=int, default=6)
    p.add_argument("--moe-model-dim", type=int, default=7168)
    p.add_argument("--moe-inter-dim", type=int, default=3072)
    p.add_argument(

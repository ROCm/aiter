...
def test_ps_metadata(
    ...
    if use_old:
        ...
        qhead_granularity = num_head_q / num_head_kv  # gqa
        qlen_granularity = min(tile_q, max_qlen)  # prefill: tile_q, decode: max_qlen
        ...
        (
            ...
            (reduce_final_map_size, reduce_final_map_type),
            (reduce_partial_map_size, reduce_partial_map_type),
        ) = aiter.get_asm_metadata_info_v1(
            batch_size=batch_size,
            max_qlen=max_qlen,
        ...
        if load_metadata:
            ...
            aiter.get_pa_metadata_v1(
                ...
                reduce_final_map,
                reduce_partial_map,
                kv_granularity=kvlen_granularity,
                block_size=block_size,
                max_seqlen_qo=max_qlen,
                uni_seqlen_qo=qlen_granularity,
                fast_mode=True,
                max_split_per_batch=3,
            )

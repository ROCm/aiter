...
using QuantMode = ck_tile::QuantType::RowColQuant;
...
template <typename AB1DataType,
          ...
          typename Scheduler        = ck_tile::GemmPipelineScheduler::Intrawave,
          typename memory_operation = ck_tile::memory_operation_enum::set>
...
using GemmEpilogue =
    ck_tile::CShuffleEpilogue<ck_tile::CShuffleEpilogueProblem<ADataType,
                                                               ...
                                                               TransposeC,
                                                               memory_operation>>;
using TileGemmTileHelperF8BlockScale =

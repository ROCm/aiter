...
#define PA_DECODE_OPUS_PYBIND          \
    ...
    m.def("pa_decode_opus_fp8_fwd",    \
          ...
          py::arg("k_scale"),          \
          py::arg("v_scale"));         \
    m.def("pa_decode_opus_fp8_ps_fwd", \
          ...
          py::arg("k_scale"),          \
          py::arg("v_scale"));         \
    m.def("pa_decode_opus_gptoss_fwd", \
          ...
          py::arg("k_scale"),          \
          py::arg("v_scale"));         \
    m.def("pa_decode_opus_gptoss_ps_fwd", \
          ...
          py::arg("k_scale"),          \
          py::arg("v_scale"));         \
    m.def("pa_decode_opus_a16w8_fwd",  \
          ...
          py::arg("k_scale"),          \
          py::arg("v_scale"),          \
          py::arg("k_scale_map") = std::nullopt, \
          py::arg("v_scale_map") = std::nullopt); \
    m.def("pa_decode_opus_a16w8_ps_fwd", \

...
#define MHA_FWD_ASM_PYBIND                        \
    m.def("fmha_v3_fwd",                          \
          ...
          py::arg("gen")          = std::nullopt);                                \
    m.def("fmha_v3_fwd_sparse",                                                   \
          &aiter::torch_itfs::fmha_v3_fwd_sparse,                                 \
          py::arg("q"),                                                           \
          py::arg("k"),                                                           \
          py::arg("v"),                                                           \
          py::arg("q_descale"),                                                   \
          ...
          py::arg("softmax_scale"),                                               \
          py::arg("out") = std::nullopt);                                         \
    m.def("fmha_v3_fwd_i8fp8_sparse_vfa",                                         \
          ...
          py::arg("lut_count"),                                                   \
          py::arg("softmax_scale"),                                               \
          py::arg("freeze_softmax_max_count"),                                    \
          py::arg("out") = std::nullopt);                                         \
    m.def("fmha_v3_fwd_mxfp4_sparse",                                             \
    ...
    m.def("fmha_v3_fwd_fp8_sparse",                                               \
          ...
          py::arg("softmax_scale"),                                               \
          py::arg("out") = std::nullopt);                                         \
    m.def("fmha_v3_fwd_fp8_sparse_vfa",                                           \
          ...
          py::arg("freeze_softmax_max_count"),                                    \
          py::arg("out") = std::nullopt);                                         \
    m.def("fmha_v3_fwd_mxfp4",                                                    \
          &aiter::torch_itfs::fmha_v3_fwd_mxfp4,                                  \
          py::arg("q"),                                                           \
          py::arg("k"),                                                           \
          py::arg("v"),                                                           \
          py::arg("q_descale"),                                                   \
          ...
          py::arg("softmax_scale"),                                               \
          py::arg("out") = std::nullopt);                                         \
    m.def("fmha_v3_fwd_f4f4",                                                     \
          &aiter::torch_itfs::fmha_v3_fwd_f4f4,                                   \
          py::arg("q"),                                                           \
          py::arg("k"),                                                           \
          py::arg("v"),                                                           \
          py::arg("q_descale"),                                                   \

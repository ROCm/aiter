...
#define ACTIVATION_PYBIND                                                      \
  ...
  m.def("scaled_silu_and_mul", &scaled_silu_and_mul,                           \
...
#define ATTENTION_ASM_MLA_PYBIND                                               \
  m.def("mla_decode_stage1_asm_fwd", &mla_decode_stage1_asm_fwd,               \
        "mla_decode_stage1_asm_fwd", py::arg("Q"), py::arg("KV"),              \
        py::arg("qo_indptr"), py::arg("kv_indptr"),                            \
        py::arg("kv_page_indices"), py::arg("kv_last_page_lens"),              \
        py::arg("max_seqlen_q"), py::arg("softmax_scale"),                     \
        py::arg("splitData"), py::arg("splitLse"));                            \
  m.def("mla_prefill_asm_fwd", &mla_prefill_asm_fwd, "mla_prefill_asm_fwd",    \
        py::arg("Q"), py::arg("KV"), py::arg("qo_indptr"),                     \
        py::arg("kv_indptr"), py::arg("kv_page_indices"),                      \
        py::arg("kv_last_page_lens"), py::arg("max_seqlen_q"),                 \
        py::arg("softmax_scale"), py::arg("splitData"), py::arg("splitLse"));

#define ATTENTION_ASM_PYBIND                                                   \
  m.def("pa_fwd_asm", &pa_fwd, "pa_fwd", py::arg("Q"), py::arg("K"),           \
        py::arg("V"), py::arg("block_tables"), py::arg("context_lens"),        \
        py::arg("max_num_blocks"), py::arg("K_QScale") = std::nullopt,         \
        py::arg("V_QScale") = std::nullopt, py::arg("out_") = std::nullopt,    \
        py::arg("high_precision") = 1);

#define ATTENTION_CK_PYBIND                                                    \
  m.def("pa_fwd_naive", &pa_fwd_naive, "pa_fwd_naive", py::arg("Q"),           \
        py::arg("K"), py::arg("V"), py::arg("block_tables"),                   \
        py::arg("context_lens"), py::arg("k_dequant_scales"),                  \
        py::arg("v_dequant_scales"), py::arg("max_seq_len"),                   \
        py::arg("num_kv_heads"), py::arg("scale_s"), py::arg("scale_k"),       \
        py::arg("scale_v"), py::arg("block_size"), py::arg("quant_algo"),      \
...
#define BATCHED_GEMM_A8W8_PYBIND                                               \
  m.def("batched_gemm_a8w8", &batched_gemm_a8w8, "batched_gemm_a8w8",          \
        py::arg("XQ"), py::arg("WQ"), py::arg("x_scale"), py::arg("w_scale"),  \
        py::arg("Out"), py::arg("bias") = std::nullopt,                        \
        py::arg("splitK") = 0);

#define BATCHED_GEMM_A8W8_TUNE_PYBIND                                          \
  m.def("batched_gemm_a8w8_tune", &batched_gemm_a8w8_tune,                     \
        "batched_gemm_a8w8_tune", py::arg("XQ"), py::arg("WQ"),                \
        py::arg("x_scale"), py::arg("w_scale"), py::arg("Out"),                \
        py::arg("kernelId") = 0, py::arg("splitK") = 0);
...
#define CACHE_PYBIND                                                           \
  ...
  m.def("copy_blocks", &copy_blocks,                                           \
        ...
        "Tensor block_mapping) -> ()");                                        \
                                                                               \
  m.def("reshape_and_cache", &reshape_and_cache, "reshape_and_cache");         \
...
#define CUSTOM_ALL_REDUCE_PYBIND                                               \
  m.def("init_custom_ar", &init_custom_ar,                                     \
        ...
        py::arg("meta"), py::arg("rank_data"), py::arg("handles"),             \
        py::arg("offsets"), py::arg("rank"), py::arg("full_nvlink"));          \
  m.def("all_reduce_reg", &all_reduce_reg,                                     \
        "all_reduce_reg(int fa, Tensor inp, Tensor! out) -> ()",               \
        py::arg("_fa"), py::arg("inp"), py::arg("out"));                       \
  m.def("all_reduce_unreg", &all_reduce_unreg,                                 \
        "all_reduce_unreg(int fa, Tensor inp, Tensor reg_buffer, Tensor! "     \
        "out) -> ()",                                                          \
        py::arg("_fa"), py::arg("inp"), py::arg("reg_buffer"),                 \
        py::arg("out"));                                                       \
  m.def("all_reduce_asm_", &all_reduce_asm, "");                               \
  m.def("all_reduce_rmsnorm_", &all_reduce_rmsnorm, "all_reduce_rmsnorm");     \
  m.def("all_reduce_rmsnorm_quant_", &all_reduce_rmsnorm_quant,                \
  ...
  m.def("get_graph_buffer_ipc_meta", &get_graph_buffer_ipc_meta,               \
        py::arg("_fa"));                                                       \
  m.def("register_graph_buffers", &register_graph_buffers, py::arg("_fa"),     \
...
#define GEMM_A8W8_ASM_PYBIND                                                   \
  m.def("gemm_a8w8_asm", &gemm_a8w8_asm,                                       \
        ...
        py::arg("XQ"), py::arg("WQ"), py::arg("x_scale"), py::arg("w_scale"),  \
        py::arg("Out"), py::arg("bias"), py::arg("sub_m") = 128,               \
        py::arg("sub_n") = 128, py::arg("pad_a") = 0, py::arg("pad_b") = 0,    \
        py::arg("pad_c") = 0, py::arg("splitK") = 0);

#define GEMM_A8W8_BLOCKSCALE_PYBIND                                            \
  m.def("gemm_a8w8_blockscale", &gemm_a8w8_blockscale, "fp8 blockscale gemm",  \
        py::arg("XQ"), py::arg("WQ"), py::arg("x_scale"), py::arg("w_scale"),  \
        py::arg("Out"));

#define GEMM_A8W8_BLOCKSCALE_TUNE_PYBIND                                       \
  m.def("gemm_a8w8_blockscale_tune", &gemm_a8w8_blockscale_tune,               \
        "gemm_a8w8_blockscale_tune", py::arg("XQ"), py::arg("WQ"),             \
        py::arg("x_scale"), py::arg("w_scale"), py::arg("Out"),                \
        py::arg("kernelId") = 0, py::arg("splitK") = 0);
...
#define GEMM_A8W8_TUNE_PYBIND                                                  \
  m.def("gemm_a8w8_tune", &gemm_a8w8_tune, "gemm_a8w8_tune", py::arg("XQ"),    \
        py::arg("WQ"), py::arg("x_scale"), py::arg("w_scale"), py::arg("Out"), \
        py::arg("kernelId") = 0, py::arg("splitK") = 0);

#define MHA_BWD_ASM_PYBIND                                                     \
  m.def("fmha_v3_bwd", &aiter::torch_itfs::fmha_v3_bwd, py::arg("dout"),       \
        py::arg("q"), py::arg("k"), py::arg("v"), py::arg("out"),              \
        py::arg("softmax_lse"), py::arg("dropout_p"),                          \
        ...
        py::arg("how_v3_bf16_cvt"), py::arg("dq") = std::nullopt,              \
...
#define MHA_VARLEN_BWD_ASM_PYBIND                                              \
  m.def("fmha_v3_varlen_bwd", &aiter::torch_itfs::fmha_v3_varlen_bwd,          \
        ...
        py::arg("out"), py::arg("softmax_lse"), py::arg("cu_seqlens_q"),       \
        ...
        py::arg("is_v3_atomic_fp32"), py::arg("how_v3_bf16_cvt"),              \
...
#define MHA_VARLEN_FWD_PYBIND                                                  \
  m.def(                                                                       \
      "mha_varlen_fwd", &aiter::torch_itfs::mha_varlen_fwd, py::arg("q"),      \
      py::arg("k"), py::arg("v"), py::arg("cu_seqlens_q"),                     \
      py::arg("cu_seqlens_k"), py::arg("max_seqlen_q"),                        \
      py::arg("max_seqlen_k"), py::arg("min_seqlen_q"),                        \
      py::arg("dropout_p"), py::arg("softmax_scale"),                          \
      py::arg("logits_soft_cap"), py::arg("zero_tensors"),                     \
      py::arg("is_causal"), py::arg("window_size_left"),                       \
      py::arg("window_size_right"), py::arg("return_softmax_lse"),             \
      py::arg("return_dropout_randval"), py::arg("out") = std::nullopt,        \
      py::arg("block_table") = std::nullopt, py::arg("bias") = std::nullopt,   \
      py::arg("alibi_slopes") = std::nullopt, py::arg("gen") = std::nullopt);

#define MHA_BATCH_PREFILL_PYBIND                                               \
  m.def(                                                                       \
      "mha_batch_prefill", &aiter::torch_itfs::mha_batch_prefill,              \
      py::arg("q"), py::arg("k"), py::arg("v"), py::arg("cu_seqlens_q"),       \
      py::arg("kv_indptr"), py::arg("kv_page_indices"),                        \
      py::arg("max_seqlen_q"), py::arg("max_seqlen_k"), py::arg("dropout_p"),  \
      py::arg("softmax_scale"), py::arg("logits_soft_cap"),                    \
...
#define MOE_CK_PYBIND                                                          \
  m.def(                                                                       \
      "ck_moe", &ck_moe, py::arg("hidden_states"), py::arg("w1"),              \
      py::arg("w2"), py::arg("topk_weights"), py::arg("topk_ids"),             \
...
#define MOE_OP_PYBIND                                                          \
  ...
  m.def("grouped_topk", &grouped_topk, py::arg("gating_output"),               \
  ...
  m.def("biased_grouped_topk", &biased_grouped_topk, py::arg("gating_output"), \
        py::arg("correction_bias"), py::arg("topk_weights"),                   \
        py::arg("topk_ids"), py::arg("num_expert_group"), py::arg("topk_grp"), \
        py::arg("need_renorm"), py::arg("routed_scaling_factor") = 1.0f,       \
  ...
  m.def("fmoe", &fmoe);                                                        \
  m.def("fmoe_int8_g1u0", &fmoe_int8_g1u0, py::arg("out"), py::arg("input"),   \
        py::arg("gate"), py::arg("down"), py::arg("sorted_token_ids"),         \
        py::arg("sorted_weights"), py::arg("sorted_expert_ids"),               \
        py::arg("num_valid_ids"), py::arg("topk"), py::arg("input_scale"),     \
        py::arg("fc1_scale"), py::arg("fc2_scale"),                            \
        py::arg("fc2_smooth_scale") = std::nullopt,                            \
        py::arg("activation") = ActivationType::Silu);                         \
  m.def("fmoe_g1u1", &fmoe_g1u1, py::arg("out"), py::arg("input"),             \
        py::arg("gate"), py::arg("down"), py::arg("sorted_token_ids"),         \
        py::arg("sorted_weights"), py::arg("sorted_expert_ids"),               \
        py::arg("num_valid_ids"), py::arg("topk"), py::arg("input_scale"),     \
        py::arg("fc1_scale"), py::arg("fc2_scale"),                            \
        py::arg("fc2_smooth_scale") = std::nullopt,                            \
        py::arg("activation") = ActivationType::Silu);                         \
  m.def("fmoe_g1u1_tkw1", &fmoe_g1u1_tkw1, py::arg("out"), py::arg("input"),   \
        py::arg("gate"), py::arg("down"), py::arg("sorted_token_ids"),         \
        py::arg("sorted_weights"), py::arg("sorted_expert_ids"),               \
        py::arg("num_valid_ids"), py::arg("topk"), py::arg("input_scale"),     \
        py::arg("fc1_scale"), py::arg("fc2_scale"),                            \
  ...
  m.def("fmoe_fp8_blockscale_g1u1", &fmoe_fp8_blockscale_g1u1, py::arg("out"), \
        py::arg("input"), py::arg("gate"), py::arg("down"),                    \
        py::arg("sorted_token_ids"), py::arg("sorted_weights"),                \
        py::arg("sorted_expert_ids"), py::arg("num_valid_ids"),                \
        py::arg("topk"), py::arg("input_scale"), py::arg("fc1_scale"),         \
        py::arg("fc2_scale"), py::arg("fc_scale_blkn") = 128,                  \
        py::arg("fc_scale_blkk") = 128,                                        \
        py::arg("fc2_smooth_scale") = std::nullopt,                            \
        py::arg("activation") = ActivationType::Silu);                         \
  m.def(                                                                       \
      "moe_stage1_g1u1", &moe_stage1_g1u1, py::arg("input"), py::arg("w1"),    \
      py::arg("w2"), py::arg("sorted_token_ids"),                              \
      py::arg("sorted_expert_ids"), py::arg("num_valid_ids"), py::arg("out"),  \
      py::arg("inter_dim"), py::arg("kernelName"), py::arg("block_m"),         \
      py::arg("ksplit") = 0, py::arg("activation") = ActivationType::Silu,     \
      py::arg("quant_type") = QuantType::No,                                   \
      py::arg("a1_scale") = std::nullopt, py::arg("w1_scale") = std::nullopt,  \
      py::arg("sorted_weights") = std::nullopt);                               \
  m.def("moe_sum", &moe_sum, "moe_sum(Tensor! input, Tensor output) -> ()");

#define MOE_SORTING_PYBIND                                                     \
  m.def("moe_sorting_fwd", &moe_sorting_fwd, py::arg("topk_ids"),              \
        py::arg("topk_weights"), py::arg("sorted_token_ids"),                  \
        py::arg("sorted_weights"), py::arg("sorted_expert_ids"),               \
        py::arg("num_valid_ids"), py::arg("moe_buf"), py::arg("num_experts"),  \
        py::arg("unit_size"), py::arg("local_expert_mask") = std::nullopt);

#define NORM_PYBIND                                                            \
  m.def("layernorm2d_fwd", &layernorm2d, py::arg("input"), py::arg("weight"),  \
        py::arg("bias"), py::arg("epsilon"),                                   \
        py::arg("x_bias") = std::nullopt);                                     \
  m.def("layernorm2d_fwd_with_add", &layernorm2d_with_add, py::arg("out"),     \
        py::arg("input"), py::arg("residual_in"), py::arg("residual_out"),     \
        py::arg("weight"), py::arg("bias"), py::arg("epsilon"),                \
        py::arg("x_bias") = std::nullopt);                                     \
  m.def("layernorm2d_fwd_with_smoothquant", &layernorm2d_with_smoothquant,     \
        py::arg("out"), py::arg("input"), py::arg("xscale"),                   \
  ...
  m.def("layernorm2d_fwd_with_add_smoothquant",                                \
        &layernorm2d_with_add_smoothquant, py::arg("out"), py::arg("input"),   \
        py::arg("residual_in"), py::arg("residual_out"), py::arg("xscale"),    \
        py::arg("yscale"), py::arg("weight"), py::arg("bias"),                 \
        py::arg("epsilon"), py::arg("x_bias") = std::nullopt);                 \
  m.def("layernorm2d_fwd_with_dynamicquant", &layernorm2d_with_dynamicquant,   \
        py::arg("out"), py::arg("input"), py::arg("yscale"),                   \
        py::arg("weight"), py::arg("bias"), py::arg("epsilon"),                \
        py::arg("x_bias") = std::nullopt);                                     \
  m.def("layernorm2d_fwd_with_add_dynamicquant",                               \
        &layernorm2d_with_add_dynamicquant, py::arg("out"), py::arg("input"),  \
        py::arg("residual_in"), py::arg("residual_out"), py::arg("yscale"),    \
        py::arg("weight"), py::arg("bias"), py::arg("epsilon"),                \
        py::arg("x_bias") = std::nullopt);                                     \
...
#define RMSNORM_PYBIND                                                         \
  ...
  m.def("fused_add_rms_norm_cu", &fused_add_rms_norm,                          \
  ...
  m.def("rmsnorm2d_fwd_with_add_smoothquant", &rmsnorm2d_with_add_smoothquant, \
        py::arg("out"), py::arg("input"), py::arg("residual_in"),              \
        py::arg("residual_out"), py::arg("xscale"), py::arg("yscale"),         \
        py::arg("weight"), py::arg("epsilon"),                                 \
...
#define HIPBSOLGEMM_PYBIND                                                     \
  ...
  m.def("hipb_destroy_extension", &hipb_destroy_extension,                     \
        "destroy_extension");                                                  \

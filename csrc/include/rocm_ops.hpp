...
#define OPUS_MOE_BWD_PYBIND \
    ...
    m.def("opus_moe_dgrad_swiglu_bf16", \
          ...
          py::arg("d_act_input"), \
          py::arg("uniform_m")); \
    m.def("opus_moe_dgrad_swiglu_dscore_bf16", \
          &opus_moe_dgrad_swiglu_dscore_bf16, \
          "MoE equal-routes dgrad + SwiGLU + dscore partials", \
          py::arg("dy"), \
          py::arg("w"), \
          py::arg("act_input"), \
          py::arg("d_act_input"), \
          ...
          py::arg("uniform_m")); \
    m.def("opus_moe_build_dgrad_meta_i32", \
          &opus_moe_build_dgrad_meta_i32, \
          "Build target MoE dgrad tile metadata on GPU", \
          py::arg("expert_offsets"), \
          py::arg("tile_metadata")); \
    m.def("opus_moe_dgrad_swiglu_dscore_ragged_bf16", \
          &opus_moe_dgrad_swiglu_dscore_ragged_bf16, \
          "MoE ragged dgrad + SwiGLU + dscore partials", \
          py::arg("dy"), \
          py::arg("w"), \
          py::arg("act_input"), \
          py::arg("d_act_input"), \
    ...
    m.def("opus_moe_combine_bwd_bf16", \
          ...
          py::arg("dy"), \
          py::arg("dp")); \
    m.def("opus_moe_combine_bwd_token8_h2048_bf16", \
          &opus_moe_combine_bwd_token8_h2048_bf16, \
          "MoE token-major combine backward (topk=8, H=2048)", \
          py::arg("dout"), \
          py::arg("token_routes"), \
          py::arg("p"), \
          py::arg("y"), \
          py::arg("dy"), \
          py::arg("dp")); \
    m.def("opus_moe_combine_scale_token8_h2048_bf16", \
          &opus_moe_combine_scale_token8_h2048_bf16, \
          "MoE token-major route scale without dscore", \
          py::arg("dout"), \
          py::arg("token_routes"), \
          py::arg("p"), \
          py::arg("dy")); \
    m.def("opus_moe_dscore_router_bwd_token8_e64_bf16", \
          &opus_moe_dscore_router_bwd_token8_e64_bf16, \
          "MoE dscore partial finalize + router backward", \
          py::arg("token_routes"), \
          py::arg("p"), \
          py::arg("partials"), \
          py::arg("order"), \
    ...
    m.def("opus_moe_gather_sum_bf16", \
          ...
          py::arg("token_routes"), \
          py::arg("dst")); \
    m.def("opus_moe_gather_sum_dscore_router_token8_h2048_e64_bf16", \
          &opus_moe_gather_sum_dscore_router_token8_h2048_e64_bf16, \
          "MoE exact dx gather plus dscore router JVP", \
          py::arg("src"), \
          py::arg("token_routes"), \
          py::arg("route_scores"), \
          py::arg("partials"), \
          ...
          py::arg("dst"), \
          py::arg("dlogits")); \
    m.def("opus_moe_gather_sum_dscore_router_dx_token8_h2048_e64_bf16", \
          &opus_moe_gather_sum_dscore_router_dx_token8_h2048_e64_bf16, \
          "MoE exact dx gather plus sparse router dx", \
          py::arg("src"), \
          py::arg("token_routes"), \
          py::arg("route_scores"), \
          py::arg("partials"), \
    ...
    m.def("opus_moe_gather_sum_dscore_router_dx_flat_meta_token8_h2048_e64_bf16", \
          ...
          py::arg("dst"), \
          py::arg("dlogits")); \
    m.def("opus_moe_gather_sum_dscore_router_dx_cached_meta_token8_h2048_e64_bf16", \
          &opus_moe_gather_sum_dscore_router_dx_cached_meta_token8_h2048_e64_bf16, \
          "MoE exact dx gather with per-token cached metadata", \
          py::arg("src"), \
          py::arg("token_routes"), \
          py::arg("route_scores"), \
          py::arg("partials"), \

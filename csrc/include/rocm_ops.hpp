...
#define PA_MQA_LOGITS_MXFP8_PYBIND               \
    m.def("pa_mqa_logits_mxfp8_fwd_prefill",     \
    ...
    m.def("pa_mqa_logits_mxfp8_fwd_decode",      \
          ...
          py::arg("kv_block_size"),              \
          py::arg("max_seq_len"));               \
    m.def("pa_mqa_logits_mxfp8_prefill_windows", \
...
#define PA_MQA_LOGITS_MXFP4_PYBIND               \
    m.def("pa_mqa_logits_mxfp4_fwd_prefill",     \
          ...
          py::arg("kv_block_size"),              \
          py::arg("max_seq_len"));               \
    m.def("pa_mqa_logits_mxfp4_fwd_decode",      \
          ...
          py::arg("kv_block_size"),              \
          py::arg("max_seq_len"));               \
    m.def("pa_mqa_logits_mxfp4_prefill_windows", \

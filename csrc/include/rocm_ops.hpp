...
#define FUSED_MINIMAX_M3_QKNORM_ROPE_KV_INSERT_PYBIND      \
    m.def("fused_minimax_m3_qknorm_rope_kv_insert",        \
    ...
    m.def("fused_minimax_m3_qknorm_rope_kv_insert_fp8",     \
          &aiter::fused_minimax_m3_qknorm_rope_kv_insert_fp8, \
          py::arg("qkv"),                                  \
          py::arg("q_norm_weight"),                        \
          py::arg("k_norm_weight"),                        \
          py::arg("cos_sin_cache"),                        \

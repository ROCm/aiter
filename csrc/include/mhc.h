...
void mhc_post_pre_gemm_sqrsum(torch::Tensor& residual_out,     // (m, hc_mult, hidden_size)
                              torch::Tensor& gemm_out_mul,     // (split_k, m, hc_mult3)
                              torch::Tensor& gemm_out_sqrsum,  // (split_k, m)
                              torch::Tensor& x,                // (m, hidden_size)
                              torch::Tensor& residual,         // (m, hc_mult, hidden_size)
...
void mhc_post_pre_mfma_gemm_sqrsum(torch::Tensor& residual_out,     // (m, hc_mult, hidden_size)
                                   torch::Tensor& gemm_out_mul,     // (split_k, m, hc_mult3)
                                   torch::Tensor& gemm_out_sqrsum,  // (split_k, m)
                                   torch::Tensor& x,                // (m, hidden_size)
                                   torch::Tensor& residual,         // (m, hc_mult, hidden_size)
                                   ...
                                   torch::Tensor& fn,               // (hc_mult3, hc_mult * hidden_size)
                                   int tile_k = 128);
void mhc_post_pre_fused_gemm_sqrsum(torch::Tensor& residual_out,     // (m, hc_mult, hidden_size)
                                    torch::Tensor& gemm_out_mul,     // (split_k, m, hc_mult3)
                                    torch::Tensor& gemm_out_sqrsum,  // (split_k, m)
                                    torch::Tensor& x,                // (m, hidden_size)
                                    torch::Tensor& residual,         // (m, hc_mult, hidden_size)

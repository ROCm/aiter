...
// Torch-free opus vectorized IO + scaled type-conversion layer.
// Split out of aiter_opus_plus.h so torch-free single-TU modules (e.g. the
// opus rmsnorm module) can reuse the coalesced load_vector_nbytes/store_vector
// path without pulling in c10 / rocprim. Depends only on opus/opus.hpp.

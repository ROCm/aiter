...
template <typename BLayout,
          ...
          typename CShuffleBlockTransferScalarPerVector_NPerBlock,
    ...
    torch::Tensor &Y)
{
    ...
    auto argument = device_gemm.MakeArgument(static_cast<ADataType*>(XQ.data_ptr()),
                                             static_cast<XPackedDataType*>(x_scale.data_ptr()),
                                             static_cast<BDataType*>(WQ.data_ptr()),
                                             static_cast<XPackedDataType*>(w_scale.GetDeviceBuffer()),
                                             static_cast<CDataType*>(Y.GetDeviceBuffer()),
                                             M,
                                             N,
                                             K,
                                             StrideA,

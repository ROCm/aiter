                                   ...
                                   int how_v3_bf16_cvt)
{
    ...
    const bool is_mxfp_packed = (data_type == "mxfp4bf16" || data_type == "mxfp6bf16" || data_type == "f6f4bf16");
                                    ...
                                    std::optional<at::Generator> gen_)
{
    ...
    if (is_mxfp_packed) {
        ...
        // fp6 Q/K (is_mxfp6): fp8 V -> "mxfp6bf16" (the f6f8 kernel, fp6-QK / fp8-PV);
        // packed fp4 V -> "f6f4bf16" (the f6f4 kernel, its own .co slot). else mxfp4.
        dtype_str = is_mxfp6 ? (is_v_fp8 ? "mxfp6bf16" : "f6f4bf16") : "mxfp4bf16";
    ...
    auto opts = q.options();
    auto out_type = (dtype_str == "fp8bf16" || dtype_str == "i8fp8bf16" || dtype_str == "mxfp4bf16" || dtype_str == "mxfp6bf16" || dtype_str == "f6f4bf16") ? torch::kBFloat16 : q.scalar_type();
    at::Tensor out;
    if (out_.has_value()) {
        out = out_.value();

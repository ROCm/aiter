...
__global__ __launch_bounds__(256, 1) void gemm_mxfp8_256x256x128_16x16x128_4wave_kernel(
    ...
    assert(false && "gemm_mxfp8 kernel requires gfx950");
    return;
#else
    using GemmTile =

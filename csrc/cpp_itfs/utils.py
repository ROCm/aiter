...
def _rocm_executable(name):
    """Locate a ROCm tool on PATH, inside an installed rocm-sdk-devel, or under
    the ROCm root cpp_extension discovers (ROCM_HOME, HIP_PATH, ...)."""

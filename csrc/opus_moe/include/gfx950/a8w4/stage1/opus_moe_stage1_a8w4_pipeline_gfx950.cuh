...
static __device__ bool opus_moe_stage1_a8w4_process_tile(
...
opus_moe_stage1_a8w4_run(const OpusMoeStage1A8W4Kargs& kargs)
{
#ifdef __HIP_DEVICE_COMPILE__
    ...
    opus_moe_stage1_a8w4_process_tile(
        kargs,
        tile,
        smem_scratch,
        smem_token,
...
{
    opus_moe_stage1_a8w4_run<Traits>(kargs);
}

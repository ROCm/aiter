...
class kernelInstance:
    ...
    def name(self) -> str:
        """
        Kernel name format in tuned CSV (Block_Per_CU appears as "<N>perCU"):
          moe_cktile2stages_gemm1_256x128x64x128_2x2_32x32x16_1perCU_fp8
          prefix_stage            BlockxMxNxK     WaveMap WaveTile ^    ^-QuantType
                                                           Block_Per_CU=1
        """
        return ("_").join(
            element

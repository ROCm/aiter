...
namespace aiter {
// group_size as template parameter: enables loop unrolling, compile-time division, and bit-shift replacement
                                      ...
                                      const int32_t num_cols_factor        = 1)
{
    ...
    float absMax      = 1e-10f;
    // fully unrolled: thread_data_size is a compile-time template constant
#pragma unroll
...
// dispatch group_size (32/64/128) to a compile-time template argument
                                        ...
                                        int num_rows_factor                       = 1)
{
    ...
    // dispatch group_size to template parameter so compiler resolves loop bounds and
    // thread-per-group counts at compile time

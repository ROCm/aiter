...
//
// Adapted from the mxfp8 kernel (mla_decode_mxfp8_16mx8_32nx1.hpp); three departures from it
// drive most of the rest:
...
__global__ void opus_mla_decode_fp8_16mx1_16nx8_kernel(opus_mla_decode_fp8_kargs)
{
}
...
namespace opus_mla_decode_fp8_16mx1_16nx8 {
...
__global__ __launch_bounds__(Traits::BLOCK_SIZE,
                             2) void opus_mla_decode_fp8_16mx1_16nx8_kernel(opus_mla_decode_fp8_kargs kargs)
{
    using namespace opus;
    using namespace opus_mla_decode_fp8_16mx1_16nx8;
    using T = opus::remove_cvref_t<Traits>;

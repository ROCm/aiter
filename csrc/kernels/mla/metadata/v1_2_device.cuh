                                  ...
                                  torch::Tensor& reduce_partial_map)
{
    ...
    // nhead<16 that divides 16 (e.g. Kimi-Linear TP=8 -> nhead=4) is padded up
    // to 16 heads by mla_decode_fwd via repeat_interleave before launch, so the
    // metadata must be generated as if num_heads==16.

...
SHAPES = [
    ...
    (512, 8192, 256, 10),  # qwen3_8_2400b (H=8192, TOPK=10)
    (513, 8192, 256, 11),  # qwen3_8_2400b shared-expert variant
    ...
    (56, 3584, 3072, 16),  # Kimi-K3 dense-expert variant (kimik3 INTER=3072)

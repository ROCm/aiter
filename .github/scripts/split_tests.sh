...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/test_fused_qk_norm_mrope_cache_quant.py]=1132
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_cache_quant.py]=1120
    FILE_TIMES[op_tests/test_mla_persistent.py]=1080
    FILE_TIMES[op_tests/test_mla_v4_nm.py]=956
    FILE_TIMES[op_tests/test_batch_prefill.py]=853
    FILE_TIMES[op_tests/test_mha.py]=850
    FILE_TIMES[op_tests/test_mla.py]=834
    FILE_TIMES[op_tests/test_pa.py]=738
    FILE_TIMES[op_tests/test_mha_varlen.py]=698
    FILE_TIMES[op_tests/test_moe_2stage.py]=646
    FILE_TIMES[op_tests/test_mla_persistent_round_robin.py]=589
    FILE_TIMES[op_tests/test_mla_sparse.py]=588
    FILE_TIMES[op_tests/test_rope.py]=412
    FILE_TIMES[op_tests/test_gemm_a8w8.py]=398
    FILE_TIMES[op_tests/test_topk_per_row.py]=375
    FILE_TIMES[op_tests/test_gated_delta_rule.py]=315
    FILE_TIMES[op_tests/test_concat_cache_mla.py]=284
    FILE_TIMES[op_tests/test_moe_topk_gating.py]=244
    FILE_TIMES[op_tests/test_mha_native_splitkv.py]=187
    FILE_TIMES[op_tests/test_pa_mtp.py]=167
    FILE_TIMES[op_tests/test_moe_dp_share_expert.py]=128
    FILE_TIMES[op_tests/test_sparse_mla_dsv4_train.py]=114
    FILE_TIMES[op_tests/test_activation.py]=90
    FILE_TIMES[op_tests/test_gemm_a8w8_blockscale_cktile_aq_rowmajor.py]=87
    FILE_TIMES[op_tests/test_flydsl_qk_norm_rope_quant.py]=84
    FILE_TIMES[op_tests/test_kvcache.py]=84
    FILE_TIMES[op_tests/test_jit_dir_with_enum.py]=68
    FILE_TIMES[op_tests/test_topk_plain.py]=67
    FILE_TIMES[op_tests/test_mhc.py]=66
    FILE_TIMES[op_tests/test_gemm_a8w8_blockscale.py]=64
    FILE_TIMES[op_tests/test_batched_gemm_bf16.py]=60
    FILE_TIMES[op_tests/test_flydsl_compress_attn.py]=60
    FILE_TIMES[op_tests/test_moe_sorting.py]=60
    FILE_TIMES[op_tests/test_pa_ps.py]=60
    FILE_TIMES[op_tests/test_quant.py]=59
    FILE_TIMES[op_tests/test_gdn_prepare.py]=58
    FILE_TIMES[op_tests/test_mha_varlen_large_kv.py]=58
    FILE_TIMES[op_tests/test_rmsnorm2d.py]=56
    FILE_TIMES[op_tests/test_causal_conv1d_update.py]=51
    FILE_TIMES[op_tests/test_batched_gemm_a8w8.py]=50
    FILE_TIMES[op_tests/test_mla_reduce.py]=44
    FILE_TIMES[op_tests/test_pa_sparse_prefill.py]=42
    FILE_TIMES[op_tests/test_pa_ragged.py]=39
    FILE_TIMES[op_tests/test_aiter_addInp.py]=36
    FILE_TIMES[op_tests/test_gemm_a4w4.py]=36
    FILE_TIMES[op_tests/test_moe_sorting_mxfp4.py]=36
    FILE_TIMES[op_tests/test_gated_rmsnorm_fp8_quant.py]=34
    FILE_TIMES[op_tests/test_moeTopkSoftmax.py]=34
    FILE_TIMES[op_tests/test_pa_ragged_experimental.py]=32
    FILE_TIMES[op_tests/test_sampling.py]=31
    FILE_TIMES[op_tests/test_aiter_add.py]=30
    FILE_TIMES[op_tests/test_pa_v1.py]=30
    FILE_TIMES[op_tests/test_moe_blockscale.py]=29
    FILE_TIMES[op_tests/test_flydsl_mla_reduce.py]=28
    FILE_TIMES[op_tests/test_kvcache_blockscale.py]=28
    FILE_TIMES[op_tests/test_sample.py]=28
    FILE_TIMES[op_tests/test_mla_prefill_ps.py]=26
    FILE_TIMES[op_tests/test_mla_ltx.py]=25
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_group_quant.py]=20
    FILE_TIMES[op_tests/test_gemm_a16w16.py]=20
    FILE_TIMES[op_tests/test_moe_tkw1.py]=20
    FILE_TIMES[op_tests/test_fused_qk_norm.py]=19
    FILE_TIMES[op_tests/test_layernorm2dFusedAddQuant.py]=19
    FILE_TIMES[op_tests/test_mla_stage2_merge.py]=19
    FILE_TIMES[op_tests/test_gemm_a6w6.py]=18
    FILE_TIMES[op_tests/test_quant_mxfp4.py]=18
    FILE_TIMES[op_tests/test_causal_conv1d_prefill_split_qkv.py]=16
    FILE_TIMES[op_tests/test_moe.py]=16
    FILE_TIMES[op_tests/test_moe_ep.py]=16
    FILE_TIMES[op_tests/test_deepgemm.py]=14
    FILE_TIMES[op_tests/test_inverse_rope_group_quant.py]=13
    FILE_TIMES[op_tests/test_smoothquant.py]=12
    FILE_TIMES[op_tests/test_rmsnorm2dFusedAddQuant.py]=11
    ...
    FILE_TIMES[op_tests/test_fused_qk_rmsnorm_group_quant.py]=10
    ...
    FILE_TIMES[op_tests/test_dsv4_indexer.py]=9
    FILE_TIMES[op_tests/test_flydsl_pa_mqa_logits_fp4.py]=9
    FILE_TIMES[op_tests/test_flydsl_pa_mqa_logits_fp4_prefill.py]=9
    FILE_TIMES[op_tests/test_indexer_k_quant_and_cache.py]=9
    FILE_TIMES[op_tests/test_quant_mxfp6_gemm.py]=9
    FILE_TIMES[op_tests/test_aiter_sigmoid.py]=8
    FILE_TIMES[op_tests/test_dsv4_rotate_quant.py]=8
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_1way_perhead.py]=8
    FILE_TIMES[op_tests/test_fused_qk_rmsnorm_per_token_quant.py]=8
    FILE_TIMES[op_tests/test_gdr_decode_packed_bf16.py]=8
    FILE_TIMES[op_tests/test_gemm_codegen.py]=8
    FILE_TIMES[op_tests/test_groupnorm.py]=8
    FILE_TIMES[op_tests/test_indexer_qk_rope_quant_and_cache.py]=8
    FILE_TIMES[op_tests/test_layernorm2d.py]=8
    FILE_TIMES[op_tests/test_mha_fp8.py]=8
    FILE_TIMES[op_tests/test_mha_v4.py]=8
    ...
    FILE_TIMES[op_tests/test_vsa_sparse_attention.py]=7
    FILE_TIMES[op_tests/test_f4gemm.py]=6
    FILE_TIMES[op_tests/test_fhmoe.py]=6
    FILE_TIMES[op_tests/test_flydsl_batched_gemm_a8w4_wo_a.py]=6
    ...
    FILE_TIMES[op_tests/test_moe_mxfp8_passthrough.py]=6
    FILE_TIMES[op_tests/test_mxfp8fp4gemm.py]=6
    FILE_TIMES[op_tests/test_pa_decode_bf16_asm.py]=6
    FILE_TIMES[op_tests/test_sonicmoe.py]=6
    FILE_TIMES[op_tests/test_topk_softmax.py]=6
    FILE_TIMES[op_tests/test_moe_aux_loss.py]=2
    FILE_TIMES[op_tests/test_pretune.py]=1
elif [[ "$TEST_TYPE" == "triton" ]]; then
    echo "Triton test files:"
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_v3.py]=1350
    FILE_TIMES[op_tests/triton_tests/conv/test_causal_conv1d.py]=768
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_fp8.py]=674
    FILE_TIMES[op_tests/triton_tests/test_pa_decode_gluon.py]=394
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a8w8_a_per_token_group_prequant_w_per_batched_tensor_quant.py]=356
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_dao_ai.py]=293
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention.py]=264
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_a16w16.py]=242
    FILE_TIMES[op_tests/triton_tests/attention/test_fav3_sage.py]=240
    FILE_TIMES[op_tests/triton_tests/rope/test_fused_qkv_split_qk_rope.py]=233
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w4.py]=214
    FILE_TIMES[op_tests/triton_tests/attention/test_mla.py]=176
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8.py]=175
    FILE_TIMES[op_tests/triton_tests/attention/test_mha.py]=174
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_afp4wfp4.py]=153
    FILE_TIMES[op_tests/triton_tests/fusions/test_mhc.py]=142
    FILE_TIMES[op_tests/triton_tests/rope/test_rope.py]=137
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode.py]=134
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_pe.py]=132
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_mul_add.py]=126
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8.py]=126
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_sink.py]=122
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing.py]=118
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8_blockscale.py]=113
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8_blockscale.py]=110
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a16w4.py]=106
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_mxfp4_quant.py]=103
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a8w8_blockscale_a16w16.py]=90
    FILE_TIMES[op_tests/triton_tests/normalization/test_rmsnorm.py]=86
    FILE_TIMES[op_tests/triton_tests/test_gmm.py]=83
    FILE_TIMES[op_tests/triton_tests/conv/test_conv2d.py]=78
    FILE_TIMES[op_tests/triton_tests/normalization/test_layernorm.py]=77
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16.py]=76
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_kv_cache.py]=70
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16_gated.py]=68
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_bmm_rope_kv_cache.py]=65
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a4w4.py]=65
    FILE_TIMES[op_tests/triton_tests/test_activation.py]=60
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_int8_smoothquant.py]=56
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_split_cat.py]=54
    FILE_TIMES[op_tests/triton_tests/chunk_delta_attn/test_flash_kda.py]=48
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16.py]=37
    FILE_TIMES[op_tests/triton_tests/test_gather_kv_b_proj.py]=36
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode_sparse.py]=22
    ...
    FILE_TIMES[op_tests/triton_tests/fusions/test_attn_res.py]=21
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8_per_token_scale.py]=21
    ...
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_clamp_act_mul.py]=13
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a16w16_quant_x.py]=13
    FILE_TIMES[op_tests/triton_tests/attention/test_fp8_mqa_logits.py]=11
    ...
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_rms_gated_fp8_group_quant.py]=9
    ...
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_rmsnorm_indexed_adaln.py]=2
    ...
    FILE_TIMES[op_tests/triton_tests/rope/test_fused_qk_norm_rope_cached.py]=2

...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/rope/test_rope.py]=402
    FILE_TIMES[op_tests/gated_delta_rule/test_gated_delta_rule.py]=322
    FILE_TIMES[op_tests/cache/test_concat_cache_mla.py]=277
    ...
    FILE_TIMES[op_tests/activation/test_activation.py]=88
    ...
    FILE_TIMES[op_tests/cache/test_kvcache.py]=78
    ...
    FILE_TIMES[op_tests/quant/test_quant.py]=56
    FILE_TIMES[op_tests/attention/mha/test_mha_varlen_large_kv.py]=55
    FILE_TIMES[op_tests/normalization/test_rmsnorm2d.py]=52
    FILE_TIMES[op_tests/gemm/test_batched_gemm_a8w8.py]=48
    FILE_TIMES[op_tests/conv/test_causal_conv1d_update.py]=47
    ...
    FILE_TIMES[op_tests/sampling/test_sampling.py]=31
    FILE_TIMES[op_tests/quant/test_gated_rmsnorm_fp8_quant.py]=30
    FILE_TIMES[op_tests/elementwise/test_aiter_add.py]=28
    FILE_TIMES[op_tests/elementwise/test_aiter_addInp.py]=28
    ...
    FILE_TIMES[op_tests/cache/test_kvcache_blockscale.py]=24
    FILE_TIMES[op_tests/moe/test_moe_blockscale.py]=24
    FILE_TIMES[op_tests/attention/mla/test_mla_ltx.py]=22
    FILE_TIMES[op_tests/sampling/test_sample.py]=22
    ...
    FILE_TIMES[op_tests/normalization/test_fused_qk_norm.py]=16
    FILE_TIMES[op_tests/gemm/test_gemm_a16w16.py]=16
    FILE_TIMES[op_tests/normalization/test_layernorm2dFusedAddQuant.py]=16
    FILE_TIMES[op_tests/attention/mla/test_mla_stage2_merge.py]=16
    FILE_TIMES[op_tests/topk/test_flydsl_dcp_topk_merge.py]=14
    FILE_TIMES[op_tests/conv/test_causal_conv1d_prefill_split_qkv.py]=13
    FILE_TIMES[op_tests/moe/test_moe_ep.py]=13
    FILE_TIMES[op_tests/moe/test_moe.py]=12
    FILE_TIMES[op_tests/conv/test_flydsl_causal_conv1d_update.py]=11
    FILE_TIMES[op_tests/gemm/test_gemm_a6w6.py]=11
    FILE_TIMES[op_tests/quant/test_quant_mxfp4.py]=11
    FILE_TIMES[op_tests/gemm/test_deepgemm.py]=10
    FILE_TIMES[op_tests/gemm/test_flydsl_hgemm.py]=10
    FILE_TIMES[op_tests/rope/test_inverse_rope_group_quant.py]=10
    FILE_TIMES[op_tests/topk/test_topk_per_row_stable.py]=10
    FILE_TIMES[op_tests/normalization/test_rmsnorm2dFusedAddQuant.py]=8
    FILE_TIMES[op_tests/quant/test_smoothquant.py]=8
    ...
    FILE_TIMES[op_tests/quant/test_fused_qk_rmsnorm_group_quant.py]=7
    ...
    FILE_TIMES[op_tests/quant/test_quant_mxfp6_gemm.py]=6
    FILE_TIMES[op_tests/gated_delta_rule/test_gdr_decode_packed_bf16.py]=5
    FILE_TIMES[op_tests/normalization/test_groupnorm.py]=5
    FILE_TIMES[op_tests/cache/test_indexer_k_quant_and_cache.py]=5
    FILE_TIMES[op_tests/cache/test_indexer_qk_rope_quant_and_cache.py]=5
    FILE_TIMES[op_tests/activation/test_situv2_and_mul_quant.py]=5
    FILE_TIMES[op_tests/topk/test_topk_row_prefill.py]=5
    FILE_TIMES[op_tests/elementwise/test_aiter_sigmoid.py]=4
    FILE_TIMES[op_tests/quant/test_dsv4_rotate_quant.py]=4
    ...
    FILE_TIMES[op_tests/quant/test_fused_qk_rmsnorm_per_token_quant.py]=4
    ...
    FILE_TIMES[op_tests/normalization/test_layernorm2d.py]=4
...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    MEMORY_WEIGHT_FLOOR[op_tests/conv/test_flydsl_causal_conv1d_update.py]=300
    ...
    MEMORY_WEIGHT_FLOOR[op_tests/cache/test_kvcache.py]=300

...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/test_fused_qk_norm_mrope_cache_quant.py]=1476
    FILE_TIMES[op_tests/test_mha.py]=980
    FILE_TIMES[op_tests/test_moe_2stage.py]=923
    FILE_TIMES[op_tests/test_mla.py]=876
    FILE_TIMES[op_tests/test_mla_persistent.py]=863
    FILE_TIMES[op_tests/test_mha_varlen.py]=730
    FILE_TIMES[op_tests/test_batch_prefill.py]=693
    FILE_TIMES[op_tests/test_pa.py]=657
    FILE_TIMES[op_tests/test_mla_sparse.py]=602
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_cache_quant.py]=532
    FILE_TIMES[op_tests/test_rope.py]=391
    FILE_TIMES[op_tests/test_topk_plain.py]=389
    FILE_TIMES[op_tests/test_topk_per_row.py]=337
    FILE_TIMES[op_tests/test_gemm_a8w8.py]=296
    FILE_TIMES[op_tests/test_moe_topk_gating.py]=252
    FILE_TIMES[op_tests/test_concat_cache_mla.py]=251
    FILE_TIMES[op_tests/test_gemm_a8w8_blockscale_cktile_aq_rowmajor.py]=165
    FILE_TIMES[op_tests/test_moe_sorting.py]=152
    FILE_TIMES[op_tests/test_pa_mtp.py]=148
    FILE_TIMES[op_tests/test_moe_dp_share_expert.py]=138
    ...
    FILE_TIMES[op_tests/test_gemm_a4w4.py]=54
    FILE_TIMES[op_tests/test_jit_dir_with_enum.py]=54
    FILE_TIMES[op_tests/test_aiter_add.py]=51
    FILE_TIMES[op_tests/test_aiter_addInp.py]=48
    FILE_TIMES[op_tests/test_pa_ps.py]=47
    FILE_TIMES[op_tests/test_batched_gemm_a8w8.py]=45
    FILE_TIMES[op_tests/test_moe_sorting_mxfp4.py]=43
    FILE_TIMES[op_tests/test_causal_conv1d.py]=41
    FILE_TIMES[op_tests/test_batched_gemm_bf16.py]=36
    FILE_TIMES[op_tests/test_mla_prefill_ps.py]=35
    FILE_TIMES[op_tests/test_pa_ragged.py]=34
    ...
    FILE_TIMES[op_tests/test_pa_v1.py]=26
    FILE_TIMES[op_tests/test_kvcache_blockscale.py]=25
    FILE_TIMES[op_tests/test_moeTopkSoftmax.py]=23
    ...
    FILE_TIMES[op_tests/test_mhc.py]=18
    ...
    FILE_TIMES[op_tests/test_layernorm2dFusedAddQuant.py]=15
    FILE_TIMES[op_tests/test_moe.py]=10
    FILE_TIMES[op_tests/test_quant_mxfp4.py]=9
    ...
    FILE_TIMES[op_tests/test_deepgemm.py]=4
    ...
    FILE_TIMES[op_tests/triton_tests/test_causal_conv1d.py]=786
    FILE_TIMES[op_tests/triton_tests/test_pa_decode_gluon.py]=758
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a8w8_a_per_token_group_prequant_w_per_batched_tensor_quant.py]=434
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_fp8.py]=343
    ...
    FILE_TIMES[op_tests/triton_tests/rope/test_fused_qkv_split_qk_rope.py]=213
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_pe.py]=198
    FILE_TIMES[op_tests/triton_tests/moe/test_moe.py]=196
    FILE_TIMES[op_tests/triton_tests/attention/test_mha.py]=172
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8.py]=169
    FILE_TIMES[op_tests/triton_tests/fusions/test_mhc.py]=152
    FILE_TIMES[op_tests/triton_tests/rope/test_rope.py]=140
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8.py]=131
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_mul_add.py]=130
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode.py]=129
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16_fused.py]=116
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8_blockscale.py]=111
    ...
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_kv_cache.py]=108
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16_gated.py]=106
    FILE_TIMES[op_tests/triton_tests/attention/test_fav3_sage.py]=105
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_sink.py]=98
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_afp4wfp4.py]=98
    FILE_TIMES[op_tests/triton_tests/normalization/test_layernorm.py]=93
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16.py]=89
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a4w4.py]=85
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a16w4.py]=78
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a8w8_blockscale_a16w16.py]=76
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w4.py]=74
    FILE_TIMES[op_tests/triton_tests/attention/test_flash_attn_kvcache.py]=72
    FILE_TIMES[op_tests/triton_tests/test_gmm.py]=68
    FILE_TIMES[op_tests/triton_tests/normalization/test_rmsnorm.py]=67
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing.py]=65
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention.py]=64
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_bmm_rope_kv_cache.py]=63
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode_sparse.py]=47
    FILE_TIMES[op_tests/triton_tests/attention/test_la.py]=45
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_fp8_quant.py]=42
    FILE_TIMES[op_tests/triton_tests/attention/test_la_paged.py]=38
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_reduce_qk_norm_rope_swa_write.py]=38
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_split_cat.py]=38
    FILE_TIMES[op_tests/triton_tests/attention/test_mla_decode_rope.py]=37
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_afp4wfp4.py]=33
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w8_blockscale.py]=21
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a8w8.py]=15
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8_blockscale.py]=9
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_rms_gated_fp8_group_quant.py]=9
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_clamp_act_mul.py]=8

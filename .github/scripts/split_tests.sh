...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_cache_quant.py]=1082
    FILE_TIMES[op_tests/test_fused_qk_norm_mrope_cache_quant.py]=1078
    FILE_TIMES[op_tests/test_mla_persistent.py]=920
    FILE_TIMES[op_tests/test_batch_prefill.py]=876
    FILE_TIMES[op_tests/test_mha.py]=856
    FILE_TIMES[op_tests/test_mla_v4_nm.py]=830
    FILE_TIMES[op_tests/test_mla.py]=816
    FILE_TIMES[op_tests/test_pa.py]=722
    FILE_TIMES[op_tests/test_mha_varlen.py]=659
    FILE_TIMES[op_tests/test_moe_2stage.py]=612
    FILE_TIMES[op_tests/test_mla_sparse.py]=589
    FILE_TIMES[op_tests/test_mla_persistent_round_robin.py]=463
    FILE_TIMES[op_tests/test_rope.py]=406
    FILE_TIMES[op_tests/test_topk_per_row.py]=340
    FILE_TIMES[op_tests/test_gated_delta_rule.py]=316
    FILE_TIMES[op_tests/test_gemm_a8w8.py]=302
    FILE_TIMES[op_tests/test_concat_cache_mla.py]=263
    FILE_TIMES[op_tests/test_pa_mtp.py]=170
    FILE_TIMES[op_tests/test_moe_dp_share_expert.py]=125
    FILE_TIMES[op_tests/test_moe_topk_gating.py]=110
    FILE_TIMES[op_tests/test_activation.py]=91
    ...
    FILE_TIMES[op_tests/test_kvcache.py]=74
    FILE_TIMES[op_tests/test_mhc.py]=70
    FILE_TIMES[op_tests/test_jit_dir_with_enum.py]=64
    FILE_TIMES[op_tests/test_flydsl_compress_attn.py]=63
    FILE_TIMES[op_tests/test_moe_sorting.py]=62
    FILE_TIMES[op_tests/test_pa_ps.py]=62
    FILE_TIMES[op_tests/test_gemm_a8w8_blockscale.py]=60
    FILE_TIMES[op_tests/test_quant.py]=60
    FILE_TIMES[op_tests/test_topk_plain.py]=60
    FILE_TIMES[op_tests/test_rmsnorm2d.py]=59
    FILE_TIMES[op_tests/test_causal_conv1d_update.py]=54
    FILE_TIMES[op_tests/test_pa_sparse_prefill_opus.py]=48
    FILE_TIMES[op_tests/test_batched_gemm_a8w8.py]=42
    FILE_TIMES[op_tests/test_batched_gemm_bf16.py]=41
    FILE_TIMES[op_tests/test_moe_sorting_mxfp4.py]=40
    FILE_TIMES[op_tests/test_pa_ragged.py]=40
    FILE_TIMES[op_tests/test_moeTopkSoftmax.py]=37
    FILE_TIMES[op_tests/test_inverse_rope_group_quant.py]=36
    FILE_TIMES[op_tests/test_flydsl_mla_reduce.py]=35
    FILE_TIMES[op_tests/test_aiter_addInp.py]=34
    FILE_TIMES[op_tests/test_gated_rmsnorm_fp8_quant.py]=34
    FILE_TIMES[op_tests/test_gemm_a4w4.py]=34
    FILE_TIMES[op_tests/test_aiter_add.py]=32
    FILE_TIMES[op_tests/test_pa_v1.py]=32
    FILE_TIMES[op_tests/test_pa_ragged_experimental.py]=30
    FILE_TIMES[op_tests/test_sample.py]=30
    FILE_TIMES[op_tests/test_sampling.py]=30
    FILE_TIMES[op_tests/test_kvcache_blockscale.py]=28
    FILE_TIMES[op_tests/test_mla_reduce.py]=28
    FILE_TIMES[op_tests/test_moe_blockscale.py]=28
    FILE_TIMES[op_tests/test_mla_ltx.py]=26
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_group_quant.py]=24
    FILE_TIMES[op_tests/test_mla_prefill_ps.py]=23
    FILE_TIMES[op_tests/test_mla_stage2_merge.py]=22
    ...
    FILE_TIMES[op_tests/test_quant_mxfp4.py]=19
    FILE_TIMES[op_tests/test_layernorm2dFusedAddQuant.py]=18
    FILE_TIMES[op_tests/test_causal_conv1d_prefill_split_qkv.py]=17
    FILE_TIMES[op_tests/test_moe_ep.py]=17
    ...
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_2way_perhead.py]=11
    ...
    FILE_TIMES[op_tests/test_groupnorm.py]=9
    FILE_TIMES[op_tests/test_mla_decode_gate.py]=9
    FILE_TIMES[op_tests/test_aiter_sigmoid.py]=8
    FILE_TIMES[op_tests/test_dsv4_rotate_quant.py]=8
    FILE_TIMES[op_tests/test_f4gemm.py]=8
    FILE_TIMES[op_tests/test_fhmoe.py]=8
    FILE_TIMES[op_tests/test_flydsl_grouped_gemm_gfx1250.py]=8
    ...
    FILE_TIMES[op_tests/test_gemm_a8w8_bpreshuffle_pad_k.py]=8
    FILE_TIMES[op_tests/test_gemm_codegen.py]=8
    FILE_TIMES[op_tests/test_indexer_k_quant_and_cache.py]=8
    FILE_TIMES[op_tests/test_jit_arch_guard.py]=8
    ...
    FILE_TIMES[op_tests/test_vsa_sparse_attention.py]=8
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_v3.py]=1360
    FILE_TIMES[op_tests/triton_tests/conv/test_causal_conv1d.py]=891
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_fp8.py]=722
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a8w8_a_per_token_group_prequant_w_per_batched_tensor_quant.py]=430
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention.py]=316
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_a16w16.py]=308
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_dao_ai.py]=297
    FILE_TIMES[op_tests/triton_tests/attention/test_fav3_sage.py]=249
    FILE_TIMES[op_tests/triton_tests/rope/test_fused_qkv_split_qk_rope.py]=244
    FILE_TIMES[op_tests/triton_tests/attention/test_mha.py]=218
    FILE_TIMES[op_tests/triton_tests/attention/test_mla.py]=217
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8.py]=194
    FILE_TIMES[op_tests/triton_tests/rope/test_rope.py]=194
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_afp4wfp4.py]=193
    FILE_TIMES[op_tests/triton_tests/moe/test_moe.py]=187
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_pe.py]=163
    FILE_TIMES[op_tests/triton_tests/fusions/test_mhc.py]=162
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention_sparse_mla.py]=155
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_sink.py]=147
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w4.py]=140
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8_blockscale.py]=136
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8_blockscale.py]=131
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_mul_add.py]=130
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_mxfp4_quant.py]=127
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_afp4wfp4.py]=122
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16_fused.py]=114
    FILE_TIMES[op_tests/triton_tests/normalization/test_rmsnorm.py]=109
    FILE_TIMES[op_tests/triton_tests/test_gmm.py]=109
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a4w4.py]=106
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a8w8_blockscale_a16w16.py]=104
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16_gated.py]=100
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16.py]=98
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode.py]=97
    FILE_TIMES[op_tests/triton_tests/normalization/test_layernorm.py]=97
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_kv_cache.py]=79
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a16w4.py]=77
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_split_cat.py]=68
    FILE_TIMES[op_tests/triton_tests/test_activation.py]=64
    ...
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_reduce_qk_norm_rope_swa_write.py]=51
    FILE_TIMES[op_tests/triton_tests/test_gather_kv_b_proj.py]=50
    FILE_TIMES[op_tests/triton_tests/attention/test_la_paged.py]=42
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_spatial_swizzle.py]=38
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a8w8_blockscale_mul_add.py]=36
    FILE_TIMES[op_tests/triton_tests/attention/test_mla_decode_rope.py]=32
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a16wfp4.py]=21
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_chunked_pa_prefill.py]=15
    FILE_TIMES[op_tests/triton_tests/chunk_delta_attn/test_chunk_delta_attn_fwd.py]=15
    FILE_TIMES[op_tests/triton_tests/conv/test_conv2d.py]=15
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_bmm_rope_kv_cache.py]=15
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_clamp_act_mul.py]=15
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_mul_add.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_afp8wfp8.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_bf16.py]=15
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8.py]=15
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_mx.py]=15
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing.py]=15
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing_sigmoid_top1_fused.py]=15
    FILE_TIMES[op_tests/triton_tests/quant/test_quant.py]=15
    FILE_TIMES[op_tests/triton_tests/test_pa_decode_gluon.py]=15
    FILE_TIMES[op_tests/triton_tests/torch_compile/test_compile_quant_per_token.py]=15
    ...
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_qk_concat.py]=10
    ...
    FILE_TIMES[op_tests/triton_tests/normalization/test_fused_add_rmsnorm_pad.py]=8
    ...
    FILE_TIMES[op_tests/triton_tests/torch_compile/test_compile_moe_routing.py]=8
    FILE_TIMES[op_tests/triton_tests/torch_compile/test_compile_rope.py]=7
    ...
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_silu_mul.py]=2

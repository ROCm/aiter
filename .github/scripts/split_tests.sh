...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/test_mla_persistent.py]=1076
    FILE_TIMES[op_tests/test_fused_qk_norm_mrope_cache_quant.py]=1068
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_cache_quant.py]=1059
    FILE_TIMES[op_tests/test_mha.py]=969
    FILE_TIMES[op_tests/test_mla_v4_nm.py]=924
    FILE_TIMES[op_tests/test_batch_prefill.py]=852
    FILE_TIMES[op_tests/test_mla.py]=832
    FILE_TIMES[op_tests/test_mha_varlen.py]=776
    FILE_TIMES[op_tests/test_pa.py]=690
    FILE_TIMES[op_tests/test_topk_per_row.py]=662
    FILE_TIMES[op_tests/test_mla_sparse.py]=602
    FILE_TIMES[op_tests/test_mla_persistent_round_robin.py]=578
    FILE_TIMES[op_tests/test_rope.py]=401
    FILE_TIMES[op_tests/test_mha_native_splitkv.py]=366
    FILE_TIMES[op_tests/test_moe_2stage.py]=268
    FILE_TIMES[op_tests/test_concat_cache_mla.py]=264
    FILE_TIMES[op_tests/test_moe_topk_gating.py]=237
    FILE_TIMES[op_tests/test_gated_delta_rule.py]=220
    FILE_TIMES[op_tests/test_gemm_a8w8.py]=191
    FILE_TIMES[op_tests/test_pa_mtp.py]=184
    FILE_TIMES[op_tests/test_moe_dp_share_expert.py]=149
    FILE_TIMES[op_tests/test_flydsl_qk_norm_rope_quant.py]=99
    ...
    FILE_TIMES[op_tests/test_flydsl_causal_conv1d_update.py]=81
    FILE_TIMES[op_tests/test_kvcache.py]=80
    FILE_TIMES[op_tests/test_gdn_prepare.py]=72
    FILE_TIMES[op_tests/test_mhc.py]=72
    FILE_TIMES[op_tests/test_flydsl_compress_attn.py]=66
    FILE_TIMES[op_tests/test_gemm_a8w8_blockscale.py]=66
    ...
    FILE_TIMES[op_tests/test_batched_gemm_bf16.py]=55
    FILE_TIMES[op_tests/test_rmsnorm2d.py]=55
    FILE_TIMES[op_tests/test_flydsl_gdr_mtp.py]=54
    FILE_TIMES[op_tests/test_batched_gemm_a8w8.py]=53
    FILE_TIMES[op_tests/test_causal_conv1d_update.py]=40
    FILE_TIMES[op_tests/test_flydsl_linear_attention_prefill.py]=40
    FILE_TIMES[op_tests/test_msa_block_select.py]=40
    FILE_TIMES[op_tests/test_mla_reduce.py]=39
    ...
    FILE_TIMES[op_tests/test_aiter_add.py]=31
    ...
    FILE_TIMES[op_tests/test_mha_varlen_large_kv.py]=28
    FILE_TIMES[op_tests/test_sampling.py]=28
    FILE_TIMES[op_tests/test_moe_blockscale.py]=26
    ...
    FILE_TIMES[op_tests/test_deepgemm.py]=17
    ...
    FILE_TIMES[op_tests/test_moe.py]=14
    ...
    FILE_TIMES[op_tests/test_flydsl_hgemm.py]=8
    FILE_TIMES[op_tests/test_fused_kv_norm_rope_group_quant.py]=8
    FILE_TIMES[op_tests/test_gemm_a6w6.py]=8
    FILE_TIMES[op_tests/test_opus_a16w16_gemm.py]=8
    ...
    FILE_TIMES[op_tests/test_mla_decode_gate.py]=5
    ...
    FILE_TIMES[op_tests/test_flydsl_gather_kv_b_proj.py]=4
    ...
    FILE_TIMES[op_tests/test_inverse_rope_group_quant.py]=4
    FILE_TIMES[op_tests/test_jit_arch_guard.py]=4
    FILE_TIMES[op_tests/test_jit_cache_transaction.py]=4
    ...
    FILE_TIMES[op_tests/test_mla_ltx.py]=4
    ...
    FILE_TIMES[op_tests/triton_tests/conv/test_causal_conv1d.py]=883
    FILE_TIMES[op_tests/triton_tests/attention/test_mha.py]=490
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a8w8_a_per_token_group_prequant_w_per_batched_tensor_quant.py]=427
    FILE_TIMES[op_tests/triton_tests/test_pa_decode_gluon.py]=422
    FILE_TIMES[op_tests/triton_tests/attention/test_fav3_sage.py]=390
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention.py]=358
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_a16w16.py]=293
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_pe.py]=283
    FILE_TIMES[op_tests/triton_tests/rope/test_fused_qkv_split_qk_rope.py]=283
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_v3.py]=256
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w4.py]=241
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8.py]=234
    FILE_TIMES[op_tests/triton_tests/attention/test_mla.py]=212
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_afp4wfp4.py]=211
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_sink.py]=190
    FILE_TIMES[op_tests/triton_tests/rope/test_rope.py]=181
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode.py]=160
    FILE_TIMES[op_tests/triton_tests/fusions/test_mhc.py]=154
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8_blockscale.py]=149
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8_blockscale.py]=142
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing.py]=140
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a16w4.py]=138
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16_fused.py]=137
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_mul_add.py]=137
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8.py]=133
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a4w4.py]=118
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_mxfp4_quant.py]=115
    FILE_TIMES[op_tests/triton_tests/normalization/test_rmsnorm.py]=111
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_afp4wfp4.py]=110
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a8w8_blockscale_a16w16.py]=109
    FILE_TIMES[op_tests/triton_tests/test_gmm.py]=103
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_kv_cache.py]=102
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16.py]=102
    FILE_TIMES[op_tests/triton_tests/conv/test_conv2d.py]=95
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_fp8.py]=71
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_int8_smoothquant.py]=71
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_split_cat.py]=63
    FILE_TIMES[op_tests/triton_tests/test_activation.py]=62
    FILE_TIMES[op_tests/triton_tests/chunk_delta_attn/test_flash_kda.py]=61
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_fp8_quant.py]=56
    FILE_TIMES[op_tests/triton_tests/test_gather_kv_b_proj.py]=56
    FILE_TIMES[op_tests/triton_tests/attention/test_fp8_mqa_logits.py]=54
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_dao_ai.py]=54
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16.py]=47
    FILE_TIMES[op_tests/triton_tests/attention/test_mla_decode_rope.py]=44
    FILE_TIMES[op_tests/triton_tests/attention/test_la_paged.py]=42
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a8w8_blockscale_mul_add.py]=41
    FILE_TIMES[op_tests/triton_tests/attention/test_chunked_pa_prefill.py]=33
    FILE_TIMES[op_tests/triton_tests/attention/test_mla_v4_triton.py]=33
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_prefill.py]=32
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a8w8.py]=31
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_spatial_swizzle.py]=29
    FILE_TIMES[op_tests/triton_tests/fusions/test_attn_res.py]=28
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode_sparse.py]=27
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_reduce_qk_norm_rope_swa_write.py]=26
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention_sparse_mla.py]=24
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_fav3_sage_compile.py]=20
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a16w16_quant_x.py]=19
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w8_blockscale.py]=18
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_clamp_act_mul.py]=17
    FILE_TIMES[op_tests/triton_tests/test_fused_rearrange_sigmoid_gdr.py]=17
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing_herd.py]=16
    FILE_TIMES[op_tests/triton_tests/chunk_delta_attn/test_chunk_delta_attn_fwd.py]=15
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_prefill_sparse.py]=14
    FILE_TIMES[op_tests/triton_tests/test_fused_kda_decode_unified.py]=13
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16wfp4.py]=12
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_bf16.py]=12
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_rms_gated_fp8_group_quant.py]=12
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8wfp4.py]=9
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_mul_add.py]=8
    FILE_TIMES[op_tests/triton_tests/quant/test_quant_fp8_blockwise.py]=8
    ...
    FILE_TIMES[op_tests/triton_tests/torch_compile/test_compile_moe_routing.py]=7
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_sparse_attention_dsv4_bwd.py]=5
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_rmsnorm_indexed_adaln.py]=5
    FILE_TIMES[op_tests/triton_tests/test_fused_kda_decode.py]=5
    FILE_TIMES[op_tests/triton_tests/test_topk.py]=5
    FILE_TIMES[op_tests/triton_tests/torch_compile/test_compile_quant_per_token.py]=5
    FILE_TIMES[op_tests/triton_tests/torch_compile/test_compile_rope.py]=5
    FILE_TIMES[op_tests/triton_tests/quant/test_convert_mxfp8.py]=4

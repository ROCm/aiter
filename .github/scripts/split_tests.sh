...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/triton_tests/linear_attention/chunk_delta_attn/test_flash_kda.py]=56
    ...
    FILE_TIMES[op_tests/triton_tests/linear_attention/chunk_delta_attn/test_fused_kda_decode.py]=24
    FILE_TIMES[op_tests/triton_tests/linear_attention/chunk_delta_attn/test_fused_kda_decode_unified.py]=24
    ...
    FILE_TIMES[op_tests/triton_tests/linear_attention/gated_delta_rule/test_fused_rearrange_sigmoid_gdr.py]=20
    ...
    FILE_TIMES[op_tests/triton_tests/linear_attention/chunk_delta_attn/test_chunk_delta_attn_fwd.py]=15

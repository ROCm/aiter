...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/test_mla_persistent_round_robin.py]=1071
    FILE_TIMES[op_tests/test_fused_qk_norm_mrope_cache_quant.py]=1017
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_cache_quant.py]=921
    FILE_TIMES[op_tests/test_mla_v4_nm.py]=870
    FILE_TIMES[op_tests/test_mla.py]=862
    FILE_TIMES[op_tests/test_mla_persistent.py]=763
    FILE_TIMES[op_tests/test_pa.py]=634
    FILE_TIMES[op_tests/test_moe_topk_gating.py]=624
    FILE_TIMES[op_tests/test_batch_prefill.py]=616
    FILE_TIMES[op_tests/test_mha.py]=583
    FILE_TIMES[op_tests/test_mla_sparse.py]=568
    FILE_TIMES[op_tests/test_mha_varlen.py]=494
    FILE_TIMES[op_tests/test_moe_2stage.py]=492
    FILE_TIMES[op_tests/test_topk_plain.py]=414
    FILE_TIMES[op_tests/test_rope.py]=400
    FILE_TIMES[op_tests/test_gemm_a8w8.py]=385
    FILE_TIMES[op_tests/test_topk_per_row.py]=270
    FILE_TIMES[op_tests/test_concat_cache_mla.py]=252
    FILE_TIMES[op_tests/test_gated_delta_rule.py]=216
    FILE_TIMES[op_tests/test_moe_dp_share_expert.py]=129
    ...
    FILE_TIMES[op_tests/test_kvcache.py]=62
    FILE_TIMES[op_tests/test_mhc.py]=54
    FILE_TIMES[op_tests/test_quant.py]=51
    FILE_TIMES[op_tests/test_moe_sorting_mxfp4.py]=47
    FILE_TIMES[op_tests/test_jit_dir_with_enum.py]=45
    FILE_TIMES[op_tests/test_gemm_a8w8_blockscale.py]=42
    FILE_TIMES[op_tests/test_pa_ps.py]=42
    FILE_TIMES[op_tests/test_rmsnorm2d.py]=40
    FILE_TIMES[op_tests/test_mla_prefill_ps.py]=38
    FILE_TIMES[op_tests/test_pa_sparse_prefill_opus.py]=38
    FILE_TIMES[op_tests/test_causal_conv1d_update.py]=34
    FILE_TIMES[op_tests/test_flydsl_compress_attn.py]=34
    ...
    FILE_TIMES[op_tests/test_batched_gemm_a8w8.py]=26
    ...
    FILE_TIMES[op_tests/test_mla_reduce.py]=22
    ...
    FILE_TIMES[op_tests/test_aiter_add.py]=19
    FILE_TIMES[op_tests/test_moeTopkSoftmax.py]=19
    FILE_TIMES[op_tests/test_moe_ep.py]=18
    ...
    FILE_TIMES[op_tests/test_flydsl_pa_mqa_logits_fp4.py]=15
    FILE_TIMES[op_tests/test_flydsl_pa_mqa_logits_fp4_prefill.py]=15
    ...
    FILE_TIMES[op_tests/test_gemm_codegen.py]=3
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_v3.py]=1456
    FILE_TIMES[op_tests/triton_tests/conv/test_causal_conv1d.py]=831
    FILE_TIMES[op_tests/triton_tests/test_pa_decode_gluon.py]=770
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_fp8.py]=736
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a8w8_a_per_token_group_prequant_w_per_batched_tensor_quant.py]=420
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_a16w16.py]=313
    FILE_TIMES[op_tests/triton_tests/attention/test_fav3_sage.py]=310
    FILE_TIMES[op_tests/triton_tests/rope/test_fused_qkv_split_qk_rope.py]=278
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_dao_ai.py]=224
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8.py]=208
    FILE_TIMES[op_tests/triton_tests/moe/test_moe.py]=207
    FILE_TIMES[op_tests/triton_tests/attention/test_mla.py]=205
    FILE_TIMES[op_tests/triton_tests/attention/test_mha.py]=200
    FILE_TIMES[op_tests/triton_tests/rope/test_rope.py]=187
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_afp4wfp4.py]=186
    FILE_TIMES[op_tests/triton_tests/fusions/test_mhc.py]=176
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention.py]=168
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention_sparse_mla.py]=167
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_pe.py]=158
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8.py]=150
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode.py]=145
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_mul_add.py]=134
    FILE_TIMES[op_tests/triton_tests/normalization/test_rmsnorm.py]=130
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_afp4wfp4.py]=128
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16_fused.py]=127
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_sink.py]=126
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w4.py]=123
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8_blockscale.py]=122
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8_blockscale.py]=119
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a4w4.py]=116
    FILE_TIMES[op_tests/triton_tests/test_gmm.py]=111
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing.py]=110
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_mxfp4_quant.py]=108
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a8w8_blockscale_a16w16.py]=105
    FILE_TIMES[op_tests/triton_tests/normalization/test_layernorm.py]=99
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16.py]=90
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a16w4.py]=88
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16_gated.py]=85
    ...
    FILE_TIMES[op_tests/triton_tests/test_activation.py]=65
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_split_cat.py]=64
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_int8_smoothquant.py]=64
    FILE_TIMES[op_tests/triton_tests/attention/test_la.py]=60
    FILE_TIMES[op_tests/triton_tests/test_gather_kv_b_proj.py]=48
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_reduce_qk_norm_rope_swa_write.py]=46
    FILE_TIMES[op_tests/triton_tests/attention/test_la_paged.py]=41
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a8w8_blockscale_mul_add.py]=39
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_chunked_pa_prefill.py]=28
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_bf16.py]=28
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a8w8.py]=27
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing_herd.py]=27
    ...
    FILE_TIMES[op_tests/triton_tests/test_fused_rearrange_sigmoid_gdr.py]=16
    ...
    FILE_TIMES[op_tests/triton_tests/quant/test_quant.py]=5

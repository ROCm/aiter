...
export PRINT_IRS=1
# best prefill fp8 sliding win: BLOCK_M=64 num_warps=4, wpeu=4, loop=0 block_size=tile_size=128
# best prefill bf16 sliding win: BLOCK_M=64 num_warps=4, wpeu=4, loop=0 block_size=tile_size=128

# best prefill fp8, BLOCK_M=128, num_warps=4, wpeu=2, loop=2 block_size=tile_size=128
# best prefill bf16, BLOCK_M=128, num_warps=4, wpeu=2, loop=2 block_size=tile_size=64
...
for lenn in 4096; do
    ...
    folder_name="6_14_${triton}_${base}"

...
| `64` | `fmha_fwd_hd128_fp8_causal_qkptph_vph_ps64_ptl.co` | 64-token pages; scalar per-page SRD-rebase 64-bit addressing (multi-TB KV pool reachable without per-lane 64-bit VALU). |

...
The [single-GPU optimization report](SINGLE_GPU_ANALYSIS.md) tracks E199–E339 local MoE experiments. Those microsecond timings are separate from the official serving results; dense candidate kernels remain isolated; E225 restores a previously selected frontend.

...
```bash
env -u PYTHONPATH /opt/conda310/bin/python -m pytest op_tests/test_mxfp4_jit_import.py -q
env -u PYTHONPATH /usr/local/bin/python3 -m pytest op_tests/test_mxfp4_jit_import.py -q
```

...
float fmha_fwd_v3_dispatcher(const ck_tile::stream_config& s, mha_fwd_args a)
{
    ...
    args.ptr_qseq_padding = a.seqstart_q_padding_ptr == nullptr ? a.seqstart_q_ptr : a.seqstart_q_padding_ptr;
    args.ptr_kseq_padding = a.seqstart_k_padding_ptr == nullptr ? a.seqstart_k_ptr : a.seqstart_k_padding_ptr;
...
float fmha_fwd_v3(mha_fwd_traits t, mha_fwd_args a, const ck_tile::stream_config& s) {
    float r = -1;

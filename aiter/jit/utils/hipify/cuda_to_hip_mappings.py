...
CUDA_IDENTIFIER_MAP = collections.OrderedDict(
    [
        ...
        (
            ...
            ("hipStreamGetCaptureInfo_v2", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipGraphInstantiateWithFlags", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        (
            ...
            ("hipGraphRetainUserObject", CONV_TYPE, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipcub::BlockRakingLayout", CONV_SPECIAL_FUNC, API_RUNTIME),
        ),
        (
            "cub::Uninitialized",
            ("hipcub::Uninitialized", CONV_SPECIAL_FUNC, API_RUNTIME),
        ),
...
C10_MAPPINGS = collections.OrderedDict(
    [
        ...
        (
            "cuda::CUDAStreamCaptureModeGuard",
            ("cuda::HIPStreamCaptureModeGuard", API_C10),
        ),

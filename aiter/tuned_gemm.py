...
from aiter import dtypes, gemm_a16w16_asm, get_semaphore_workspace, hipb_create_extension, hipb_mm, logger
...
def asm_gemm(
    ...
    return gemm_a16w16_asm(inp, weights, out_asm, sema, bias, splitK, KernelName, bpreshuffle)

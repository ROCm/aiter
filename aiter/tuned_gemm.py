...
def flydsl_gemm(
    ...
    out = flydsl_gemm_kernels.flydsl_hgemm(
        ...
        weights,
        bias=fused_bias,
        tile_m=flydsl_config["block_m"],
        tile_n=flydsl_config["block_n"],
        tile_k=flydsl_config["block_k"],
        split_k=flydsl_config["split_k"],
        block_m_warps=flydsl_config["m_waves"],
        block_n_warps=flydsl_config["n_waves"],
        block_k_warps=flydsl_config["k_waves"],

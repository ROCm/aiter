...
# These are hardware constants that do not change for the lifetime of the
# process. Caching them at module import time avoids repeated HIP runtime
# calls on the decode hot path.
...
def get_2stage_cfgs(
    ...
    if cfg is None or int(os.environ.get("AITER_BYPASS_TUNE_CONFIG", "0")):
        ...
        if (
            ...
            use_g1u1,
            doweight_stage1,
        ) in fused_moe_1stage_dict.get(gfx, {}):

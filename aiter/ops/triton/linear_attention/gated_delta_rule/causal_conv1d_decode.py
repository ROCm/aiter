...
``aiter.ops.triton._triton_kernels.linear_attention.gated_delta_rule.decode.causal_conv1d_update_split_qkv``.
"""

import torch
import triton

from aiter.ops.triton._triton_kernels.linear_attention.gated_delta_rule.decode.causal_conv1d_update_split_qkv import (
    PAD_SLOT_ID,

...
def reduce_grouped(
    ...
    # Gluon fast path: always used on gfx1250 for the post-MoE2 expert combine; fused swiglu and non-contiguous inputs fall back to the Triton _reduce_grouped.
    use_gluon = (
        is_tdm_avail()
        and _reduce_grouped_gluon is not None

...
# generate_inputs returns 6 values; x_scales_kernel is the kernel-layout copy of
# x_scales and is what the preshuffle kernel takes. The generator defaults to MX
# (32) while the op defaults to blockscale (128), so pass the same value to both
# or the kernel rejects the x_scales shape.
x_scale_group_size = SCALE_GROUP_SIZE

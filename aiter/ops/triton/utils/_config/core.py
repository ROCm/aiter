...
"""Shared core of the config machinery: paths, JSON loading, and the
nested-layout directory builder every loader goes through. Import these via
``aiter.ops.triton.utils.config_utils`` -- this package is private.
"""

...
def _silu_and_mul_backward_kernel(
    ...
    grad_output_row_stride = tl.cast(grad_output_row_stride, tl.int64)
    grad_output_col_stride = tl.cast(grad_output_col_stride, tl.int64)
    input_row_stride = tl.cast(input_row_stride, tl.int64)
    input_col_stride = tl.cast(input_col_stride, tl.int64)
    grad_input_row_stride = tl.cast(grad_input_row_stride, tl.int64)
    grad_input_col_stride = tl.cast(grad_input_col_stride, tl.int64)
    ...
    n_cols_i64 = tl.cast(n_cols, tl.int64)

...
def get_autotune_fwd_configs():
    pinned = get_tuned_kernel_config(
        "attention", "MXFP8_ATTN", "attn_fwd_mxfp8", _FWD_FALLBACK
    )
    return autotune_configs("MXFP8_ATTN_FWD", [pinned], pinned), [
        "IS_CAUSAL",
        "dropout_p",
        "MAX_SEQLENS_Q",
        "MAX_SEQLENS_K",
...
_attn_fwd_mxfp8_repr = make_kernel_repr(
    "attn_fwd_mxfp8",
    [
        "BLOCK_M",
        "BLOCK_N",
...
@triton.jit(repr=_attn_fwd_mxfp8_repr)
def attn_fwd_mxfp8(
    Q,
    K,
    V,
...
_bwd_preprocess_use_o_mxfp8_repr = make_kernel_repr(
...
@triton.jit(repr=_bwd_preprocess_use_o_mxfp8_repr)
...
_bwd_kernel_dkdv_mxfp8_repr = make_kernel_repr(
...
@triton.jit(repr=_bwd_kernel_dkdv_mxfp8_repr)
...
_bwd_kernel_dq_mxfp8_repr = make_kernel_repr(
...
@triton.jit(repr=_bwd_kernel_dq_mxfp8_repr)

...
def _sage_fwd_blocksparse(
    ...
    # Loop 1: indices 0 .. n_blocks-2, unmasked K,V loads (last K block is last in LUT)
    ...
    # Loop 2: final index (n_blocks-1), masked K,V loads for possible partial last block

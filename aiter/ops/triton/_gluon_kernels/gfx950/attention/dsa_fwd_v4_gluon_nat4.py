...
@gluon.jit
def _sparse_mla_fwd_nat4_kernel(
...
# Launcher
# =====================================================================
def sparse_mla_fwd_v4_gluon_nat4(q, kv, topk_indices, attn_sink=None, kv_lora_rank=512, scale=None):
    ...
    _sparse_mla_fwd_nat4_kernel[grid](

...
def create_default_config(
    ...
    Args:
        ...
        tag: Tag prefix to match config files (e.g., "A8W8_BLOCKSCALE")
...
def main():
    ...
    default_config = create_default_config(all_configs, save_path, dev, "A8W8_BLOCKSCALE")
    save_default_config(default_config, save_path, dev, "A8W8_BLOCKSCALE")

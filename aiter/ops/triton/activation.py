...
@triton.jit
def _act_mul_and_dynamic_mxfp4_quant_kernel_shuffle_scales(
    x_ptr,
    x_fp4_ptr,
    bs_ptr,
    stride_x_m_in,
...
def act_mul_and_mxfp4_quant_shuffle_scales(
    x: torch.Tensor,
    activation: Literal["silu", "gelu", "gelu_tanh"],
    scaling_mode: str = "even",
) -> tuple[torch.Tensor, torch.Tensor]:
    ...
    _act_mul_and_dynamic_mxfp4_quant_kernel_shuffle_scales[grid](
        x,
        x_fp4,
        blockscale_e8m0,
        *x.stride(),

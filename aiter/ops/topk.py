...
_FLYDSL_HERD_MIN_M = int(os.environ.get("AITER_FLYDSL_HERD_MIN_M", "16"))
_FLYDSL_HERD_MAX_M = int(os.environ.get("AITER_FLYDSL_HERD_MAX_M", "128"))
...
def _use_flydsl_herd(
    ...
    # FlyDSL only after the opt-in and cheap shape checks have passed.

...
@compile_ops(
    "module_fused_minimax_m3_qknorm_rope_kv_insert",
    fc_name="fused_minimax_m3_qknorm_rope_kv_insert",
)
def _fused_minimax_m3_qknorm_rope_kv_insert_hip(
    qkv: Tensor,
...
@compile_ops(
    "module_fused_minimax_m3_qknorm_rope_kv_insert",
    fc_name="fused_minimax_m3_qknorm_rope_kv_insert_fp8",
)
def _fused_minimax_m3_qknorm_rope_kv_insert_fp8_hip(
    qkv: Tensor,
    q_norm_weight: Tensor,
    k_norm_weight: Tensor,
    cos_sin_cache: Tensor,
...
def fused_minimax_m3_qknorm_rope_kv_insert(
    ...
    if (
        ...
        _fused_minimax_m3_qknorm_rope_kv_insert_fp8_hip(
            qkv,
            q_norm_weight,
            k_norm_weight,
            cos_sin_cache,
    ...
    _fused_minimax_m3_qknorm_rope_kv_insert_hip(
        qkv,
        q_norm_weight,
        k_norm_weight,
        cos_sin_cache,

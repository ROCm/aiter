...
def add(input: Tensor, other: Tensor) -> Tensor:
    ...
    out = _add(input, other, custom_build_args={"md_name": "module_aiter_add_"+dtype_str, "blob_gen_cmd": blob_gen_cmd})
    return out
...
def sub(input: Tensor, other: Tensor) -> Tensor:
    ...
    out = _sub(input, other, custom_build_args={"md_name": "module_aiter_sub_"+dtype_str, "blob_gen_cmd": blob_gen_cmd})
    return out
...
def mul(input: Tensor, other: Tensor) -> Tensor:
    ...
    out = _mul(input, other, custom_build_args={"md_name": "module_aiter_mul_"+dtype_str, "blob_gen_cmd": blob_gen_cmd})
    return out
...
def div(input: Tensor, other: Tensor) -> Tensor:
    ...
    out = _div(input, other, custom_build_args={"md_name": "module_aiter_div_"+dtype_str, "blob_gen_cmd": blob_gen_cmd})
    return out
...
def add_(input: Tensor, other: Tensor) -> Tensor:
    ...
    out = _add_(input, other, custom_build_args={"md_name": "module_aiter_add_"+dtype_str, "blob_gen_cmd": blob_gen_cmd})
    return out
...
def sub_(input: Tensor, other: Tensor) -> Tensor:
    ...
    out = _sub_(input, other, custom_build_args={"md_name": "module_aiter_sub_"+dtype_str, "blob_gen_cmd": blob_gen_cmd})
    return out
...
def mul_(input: Tensor, other: Tensor) -> Tensor:
    ...
    out = _mul_(input, other, custom_build_args={"md_name": "module_aiter_mul_"+dtype_str, "blob_gen_cmd": blob_gen_cmd})
    return out
...
def div_(input: Tensor, other: Tensor) -> Tensor:
    ...
    out = _div_(input, other, custom_build_args={"md_name": "module_aiter_div_"+dtype_str, "blob_gen_cmd": blob_gen_cmd})
    return out

...
def cmdGenFunc(
    op_name: str, input: Tensor, other: Tensor, out: Tensor
) -> dict[str, Any]:
...
def add(input: Tensor, other: Tensor, out: Tensor) -> None: ...


@compile_ops("module_aiter_operator", gen_func=binary_sub_build_args)
def sub(input: Tensor, other: Tensor, out: Tensor) -> None: ...


@compile_ops("module_aiter_operator", gen_func=binary_mul_build_args)
def mul(input: Tensor, other: Tensor, out: Tensor) -> None: ...


@compile_ops("module_aiter_operator", gen_func=binary_div_build_args)
def div(input: Tensor, other: Tensor, out: Tensor) -> None: ...


@compile_ops("module_aiter_operator", gen_func=binary_add_build_args)
def add_(input: Tensor, other: Tensor) -> None: ...


@compile_ops("module_aiter_operator", gen_func=binary_sub_build_args)
def sub_(input: Tensor, other: Tensor) -> None: ...


@compile_ops("module_aiter_operator", gen_func=binary_mul_build_args)
def mul_(input: Tensor, other: Tensor) -> None: ...


@compile_ops("module_aiter_operator", gen_func=binary_div_build_args)
def div_(input: Tensor, other: Tensor) -> None: ...


@compile_ops("module_aiter_unary")
def sigmoid(input: Tensor, out: Tensor) -> None: ...


@compile_ops("module_aiter_unary")
def tanh(input: Tensor, out: Tensor) -> None: ...

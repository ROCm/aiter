...
@compile_ops("module_activation")
def fused_silu_mul_per_token_quant(out: Tensor, scales: Tensor, input: Tensor) -> None: ...


@compile_ops("module_activation")
def fused_gelu_mul_per_token_quant(out: Tensor, scales: Tensor, input: Tensor) -> None: ...


@compile_ops("module_activation")
def fused_gelu_tanh_mul_per_token_quant(out: Tensor, scales: Tensor, input: Tensor) -> None: ...

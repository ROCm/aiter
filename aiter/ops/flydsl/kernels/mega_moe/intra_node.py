...
"""FlyDSL intra-node backend for MegaMoEV2."""
...
__all__ = ["MegaMoEIntraNodeBackend"]


class MegaMoEIntraNodeBackend:
    """Existing A8W4 fused stage1/stage2 implementation for intra-node EP."""
    ...
    # fmt: on
        if quant != "a8w4":
            raise ValueError("MegaMoEIntraNodeBackend supports quant='a8w4' only")
        ...
        if max_tok_per_rank & (max_tok_per_rank - 1):

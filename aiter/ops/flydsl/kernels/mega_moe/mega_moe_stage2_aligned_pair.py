...
def compile_mega_moe_stage2_aligned_pair(*, model_dim: int, inter_dim: int,
    ...
    g2_ascale_pf=True, g2_b2stage: bool = True, g2_deep_a_pipeline: bool = False,
    a_dtype: str = "fp8"):
# fmt: on
    ...
    kernel_name = (
        ...
        f"_b2{int(g2_b2stage)}dap{int(g2_deep_a_pipeline)}"
        "_rtv3_rq2_hw1"
    )
    ...
    # fmt: on
        ...
        def run_pair(m_block):
            ...
            acc_a, _ = gemm2_compute_v2(
                ...
                g2_b2stage=g2_b2stage, g2_deep_a_pipeline=g2_deep_a_pipeline,

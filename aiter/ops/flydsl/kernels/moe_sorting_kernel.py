...
def moe_sorting_flydsl(
    ...
    *,
    ...
    if has_local_tokens != specialization.has_local_tokens:
        raise ValueError(
            "runtime local-token state disagrees with sorting specialization: "
            f"{has_local_tokens} != {specialization.has_local_tokens}"
        )

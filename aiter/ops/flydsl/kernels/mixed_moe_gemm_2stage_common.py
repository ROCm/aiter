...
"""Shared ordinary stage1 kernel builder.

This module contains the ordinary stage1 kernel builder. FHMoE stage2 uses the
layout-v2 MXFP4 kernel and is implemented in the dedicated dispatcher.
...
# This stage2 builder is intentionally retained for FHMoE. Ordinary quantized
# MoE stage2 no longer reaches this function; it uses flydsl_moe2_layout_*.

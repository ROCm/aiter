...
"""
Gated Delta Net K5 hidden-state recurrence kernel -- un-pipelined KV fork.
...
before any hand-scheduling is layered back on:
...
def compile_chunk_gated_delta_h_kv(
    *,
    ...
    allocator = SmemAllocator(
        None,
        arch=GPU_ARCH,
        global_sym_name=f"gdn_h_kv_withldsg_smem_v{_K5_KERNEL_REVISION}",
    )

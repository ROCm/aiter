"""Fused heterogeneous MoE (FHMoE) MXFP4/FP8 GEMM kernel builders."""
...
def compile_mixed_fhmoe_gemm1(
    *,
    ...
    module_name = (
        ...
        f"_t{tile_m}x{tile_n}x{tile_k}_pm{persist_m}{fp4q_tag}{fp8q_tag}{sort_tag}{async_tag}{sk_tag}{kw_tag}{go_tag}{gui_tag}{as1_tag}{heterogeneous_tag}_v33"
    ).replace("-", "_")
        ...
        def moe_gemm1(
            ...
            def moe_gemm1_body(shared_b: bool = False):
                ...
                def load_b_packs_k64(base_k, ku: int, n_blk, n_intra):
                    ...
                    b0, b1 = load_cell(w_rsrc, layout_b, w_elem_type(), routed_k0_base)
...
def compile_mixed_fhmoe_gemm2(
    *,
    ...
    module_name = (
        ...
        f"_vscale_fix3_fp4opt_v2{pm_tag}{sbm_tag}{wpe_tag}{async_tag}{cumul_tag}{acc_tag}{heterogeneous_tag}{serial_n_tag}"
    ).replace("-", "_")

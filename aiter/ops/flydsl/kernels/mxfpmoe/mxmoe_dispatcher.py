...
def compile_gemm2_a4w4_port(
    ...
    tag = f"h{D_HIDDEN}_i{D_INTER}_bm{BM}{tile_tag}{'_nt' if use_nt else ''}_{etag}{atag}{btag}{sbm_tag}{shared_scale_tag}{persist_tag}{bh_tag}{apf_tag}{spart_tag}{bf16lds_tag}{noil_tag}{dw_tag}{kst_tag}{pitch_tag}{sblk_tag}{out_tag}{compact_tag}{bias_tag}{output_range_tag}_v2_biasabi7{route_guard_tag}"
    ...
    def _gemm2_kernel_body(
        ...
        def run_unit(unit_bx, mn_idx=None):
            gemm2_body_v2(
                ...
                route_guard=(_composition is not None and use_reduce),
            )
    ...
    def _gemm2_tile(
        ...
        _gemm2_kernel_body(
            ...
            arg_bscale,
            arg_eids,
            arg_stids,  # dummy cumsum; mn_idx skips the scheduler
            arg_stids,
            arg_sweights,
            arg_bias,
            arg_out,

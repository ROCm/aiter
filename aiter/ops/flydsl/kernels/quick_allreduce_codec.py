...
group-16 signed E4M3 scale. INT4 is one nibble plane; INT5/INT6 add a dense
...
# 1024 B nibbles, 256 B 1-bit plane, 128 B scale; 1408 B rank-tile, 22 sectors.
INT5 = Codec(
    name="int5",
    bits=5,
    bias=16,
...
CODECS = {c.name: c for c in (INT4, INT5, INT6, FP16)}

    ...
    def kernel_mxscale_gemm(
        ...
        def _emit_tile(
            ...
            if const_expr(grouped_contiguous_m):
                ...
                c_rows = m_idx * arith.index(split_k)
            c_row_byte_i64 = (
                arith.index_cast(T.i64, flat_m_base)
                * arith.index_cast(T.i64, n_stride)
                * arith.constant(elem_bytes_d, type=T.i64)
            )
            c_base_i64 = arith.index_cast(T.i64, ptrtoint(arg_c)) + c_row_byte_i64
            ...
            c_rsrc = buffer_ops.create_buffer_resource_from_addr(
                c_base_i64, num_records_bytes=c_nrec
            )

...
# module-level K/N/N_BLOCKS (unlike the legacy non-gen forward). Seed the single-D
...
def configure_dim(D):
    ...
    K = N = D
    SPLIT = _active.split
    # Keep a legacy non-gen forward module's K/N in sync for any legacy co-launch.

...
@functools.cache
def compile_mixed_moe_gemm1_multi_b(
    *,
    model_dim: int,
    inter_dim: int,
    experts: int,
    ...
    """Compile the gfx950 pointer-table stage1 multi-B kernel."""
    return compile_mixed_moe_gemm1_common(
        model_dim=model_dim,
        inter_dim=inter_dim,
        experts=experts,
...
@functools.cache
def compile_mixed_moe_gemm2_multi_b(
    *,
    model_dim: int,
    inter_dim: int,
    experts: int,
    ...
    """Compile the gfx950 pointer-table stage2 multi-B kernel."""
    return compile_mixed_moe_gemm2_common(
        model_dim=model_dim,
        inter_dim=inter_dim,
        experts=experts,

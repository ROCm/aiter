...
def compile_flydsl_moe_stage1(
    ...
    if a_dtype == "bf16" and b_dtype in ("fp4", "mxfp4"):
        ...
        builder = (
            ...
            else compile_mixed_moe_gemm1_a16w4
        )
        return builder(
            model_dim=model_dim,
            inter_dim=inter_dim,
...
def compile_flydsl_moe_stage2(
    ...
    if a_dtype == "bf16" and b_dtype in ("fp4", "mxfp4"):
        ...
        builder = (
            ...
            if compile_target is not None
            else compile_mixed_moe_gemm2_a16w4
        )
        return builder(
            model_dim=model_dim,
            inter_dim=inter_dim,
...
def _get_compiled_silu_fused(
    ...
    Explicit targets also enter the wrapper cache key."""
...
def flydsl_moe_stage1(
    ...
    *,
    ...
    legacy_use_mx_gemm = b_dtype in ("fp4", "mxfp4", "fp8")

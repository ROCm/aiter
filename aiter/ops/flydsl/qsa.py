...
Phase 2c: family A FlyDSL K1 writes ``block_ids [M, 512]`` from paged
compressed K (512-slot tiles, no score matrix). Decode and prefill share
one instantiation. Expand+tail and K2 are still separate.

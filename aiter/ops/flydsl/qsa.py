...
compressed K (short-row emit; decode splits after one 512-slot tile and
pair-merges heaps; prefill streams tiles, no score matrix). Expand+tail and K2 are still separate.

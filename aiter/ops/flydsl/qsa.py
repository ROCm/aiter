...
Phase 2b: family A FlyDSL K1 writes ``block_ids [M, 512]`` from paged
compressed K by tiling 512-slot heaps (no score matrix). Expand+tail and
K2 are still separate.

...
"""Tune catalog for the FlyDSL MXFP4/MXFP8 preshuffle GEMM."""
...
_DTYPE_SHORT = {"fp8": "F8", "fp4": "F4", "bf16": "B16", "fp16": "F16"}
_SHORT_DTYPE = {value: key for key, value in _DTYPE_SHORT.items()}

_COMBOS = [("fp4", "fp4"), ("fp8", "fp8")]
...
def _max_lds_bytes() -> int:
    return get_lds_capacity_bytes("gfx950")

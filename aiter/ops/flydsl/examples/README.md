...
examples/
  ...
  <op>/
    ...
    config.json         # shapes + tiling/params for this op
...
1. Create `examples/<op>/` and copy the four-file layout above.
...
5. `README.md`: the math, how to run, expected output, and the config schema.

...
parts that cannot be reflected safely: stable identity, launcher ABI, and unit
selection. Callable parameters and defaults always come from the referenced
compiler itself.
"""
...
def op(
    ...
    *,
    ...
    return CompileOp(op_id, compiler, abi)
...
def plan_provider(provider: Callable[..., Any]) -> Callable[..., CompilePlan]:
    """Turn ``provider(plan, ...)`` declarations into a plan resolver."""
